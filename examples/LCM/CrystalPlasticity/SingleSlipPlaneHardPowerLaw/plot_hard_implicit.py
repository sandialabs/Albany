...
file_name = "SingleSlipPlaneHardPowerLaw_Implicit.e"
...
## To verify power-law hardening, need H and p
H = 2.0
p = 0.5
...
for i in range(n_steps):
    ...
    verify_var[i] = H*abs(inp_var[i])**p
...
ax.plot(inp_var[:-1],verify_var[:-1],color='red',label='power-law')
