...
output_file_name = file_name[:-2] + "_" + dep_var_name + ".pdf"
output_file_name_2 = file_name[:-2] + "_" + dep_var_name_2 + ".pdf"
output_file_name_3 = file_name[:-2] + "_" + dep_var_name_3 + ".pdf"
...
fig, ax = plt.subplots()
ax.plot(inp_var[:-1],numpy.abs(dep_var_3[:-1]),color='blue',marker='o',label=file_name)
plt.xlabel(inp_var_name)
