...
if __name__ == "__main__":
    ...
    block_1_displacement = []
    block_1_force = []
    block_2_displacement = []
    block_2_force = []
    ...
    for timeStep in range(numTimeSteps):
        ...
        # For block_1, the x-max face is nodeset_2
        ...
        block_1_displacement.append(displacement)
        block_1_force.append(force)

        # For block_2, the x-max face is nodeset_12
        nodeSet = nodeSetNodes[12]
        displacement = 0.0
        force = 0.0
        for nodeId in nodeSet:
            displacement += displacement_x[nodeId-1]
            force += force_x[nodeId-1]
        displacement /= len(nodeSet)
        block_2_displacement.append(displacement)
        block_2_force.append(force)
