...
if(DEFINED MPIMNP AND ${MPIMNP} GREATER 1)
  SET(EXODIFF_TEST ${SEACAS_EXODIFF} -i -m -f ${DATA_DIR}/${TEST_NAME}.exodiff_commands physics_0_mitchell.exo ${DATA_DIR}/${TEST_NAME}.ref.exo)
ELSE()
  SET(EXODIFF_TEST ${SEACAS_EXODIFF} -i -f ${DATA_DIR}/${TEST_NAME}.exodiff_commands physics_0_mitchell.exo ${DATA_DIR}/${TEST_NAME}.ref.exo)
ENDIF()
