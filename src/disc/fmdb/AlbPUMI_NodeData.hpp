...
public:
  ...
  virtual void saveFieldBlock(const Teuchos::RCP<const Tpetra_BlockMultiVector>& block_mv, int offset);
  virtual void saveFieldVector(const Teuchos::RCP<const Tpetra_MultiVector>& mv, int offset);
