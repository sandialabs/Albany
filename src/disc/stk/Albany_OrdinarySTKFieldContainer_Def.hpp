...
template <bool Interleaved>
void
Albany::OrdinarySTKFieldContainer<Interleaved>::initializeSTKAdaptation()
{
...
template <bool Interleaved>
void
Albany::OrdinarySTKFieldContainer<Interleaved>::fillSolnVector(
    Epetra_Vector&                        soln,
...
template <bool Interleaved>
void
Albany::OrdinarySTKFieldContainer<Interleaved>::fillSolnVectorT(
    Tpetra_Vector&                        solnT,
    stk::mesh::Selector&                  sel,
...
template <bool Interleaved>
void
Albany::OrdinarySTKFieldContainer<Interleaved>::fillSolnMultiVector(
  ...
  for (stk::mesh::BucketVector::const_iterator it = all_elements.begin();
    ...
    for (int vector_component = 0; vector_component < solnT.getNumVectors();
      ...
      this->fillMultiVectorHelper(
          solnT,
          solution_field[vector_component],
          node_mapT,
          bucket,
          vector_component,
          0);
...
template <bool Interleaved>
void
Albany::OrdinarySTKFieldContainer<Interleaved>::fillVector(
...
template <bool Interleaved>
void
Albany::OrdinarySTKFieldContainer<Interleaved>::saveVector(
...
template <bool Interleaved>
void
Albany::OrdinarySTKFieldContainer<Interleaved>::saveSolnVector(
...
template <bool Interleaved>
void
Albany::OrdinarySTKFieldContainer<Interleaved>::fillVectorT(
...
template <bool Interleaved>
void
Albany::OrdinarySTKFieldContainer<Interleaved>::saveVectorT(
...
template <bool Interleaved>
void
Albany::OrdinarySTKFieldContainer<Interleaved>::saveSolnVectorT(
    ...
    const Teuchos::RCP<const Tpetra_Map>& node_mapT)
{
  ...
  for (stk::mesh::BucketVector::const_iterator it = all_elements.begin();
    ...
    this->saveVectorHelperT(soln_dotT, solution_field[1], node_mapT, bucket, 0);
    this->saveVectorHelperT(
        soln_dotdotT, solution_field[2], node_mapT, bucket, 0);
  }
}

template <bool Interleaved>
void
Albany::OrdinarySTKFieldContainer<Interleaved>::saveSolnMultiVector(
...
template <bool Interleaved>
void
Albany::OrdinarySTKFieldContainer<Interleaved>::saveResVector(
...
template <bool Interleaved>
void
Albany::OrdinarySTKFieldContainer<Interleaved>::saveResVectorT(
...
template <bool Interleaved>
void
Albany::OrdinarySTKFieldContainer<Interleaved>::transferSolutionToCoords()
{
