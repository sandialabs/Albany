...
/*
Teuchos::RCP<const Epetra_Vector> QCAD::CoupledPoissonSchrodingerT::get_x_init() const
{
...
Teuchos::RCP<const Epetra_Vector> QCAD::CoupledPoissonSchrodingerT::get_x_dot_init() const
{
...
Teuchos::RCP<const Epetra_Vector> QCAD::CoupledPoissonSchrodingerT::get_p_init(int l) const
{
  TEUCHOS_TEST_FOR_EXCEPTION(l >= num_param_vecs || l < 0, Teuchos::Exceptions::InvalidParameter,
                     std::endl <<
                     "Error in QCAD::CoupledPoissonSchrodingerT::get_p_init():  " <<
                     "Invalid parameter index l = " << l << std::endl);
...
QCAD::CoupledPoissonSchrodingerT::getNominalValues() const
{
...
Thyra::ModelEvaluatorBase::InArgs<ST>
QCAD::CoupledPoissonSchrodingerT::getLowerBounds() const
{
#ifdef OUTPUT_TO_SCREEN
  std::cout << "DEBUG: " << __PRETTY_FUNCTION__ << "\n";
#endif
...
Thyra::ModelEvaluatorBase::InArgs<ST>
QCAD::CoupledPoissonSchrodingerT::getUpperBounds() const
{
#ifdef OUTPUT_TO_SCREEN
  std::cout << "DEBUG: " << __PRETTY_FUNCTION__ << "\n";
#endif
...
QCAD::CoupledPoissonSchrodingerT::create_W_prec() const
{
#ifdef OUTPUT_TO_SCREEN
  std::cout << "DEBUG: " << __PRETTY_FUNCTION__ << "\n";
#endif
...
QCAD::CoupledPoissonSchrodingerT::get_W_factory() const
{
#ifdef OUTPUT_TO_SCREEN
  std::cout << "DEBUG: " << __PRETTY_FUNCTION__ << "\n";
#endif
...
void
QCAD::CoupledPoissonSchrodingerT::reportFinalPoint(
    ...
    bool const was_solved)
{
  ...
  TEUCHOS_TEST_FOR_EXCEPTION(true,
      Teuchos::Exceptions::InvalidParameter,
      "Calling reportFinalPoint in QCAD_CoupledPoissonSchrodingerT.cpp" << '\n');
}
...
Thyra::ModelEvaluatorBase::InArgs<ST>
QCAD::CoupledPoissonSchrodingerT::createInArgs() const
{
#ifdef OUTPUT_TO_SCREEN
  std::cout << "DEBUG: " << __PRETTY_FUNCTION__ << "\n";
#endif
...
/*  //?? Teuchos::TimeMonitor Timer(*timer); //start timer
  ...
  if (x_dot != Teuchos::null) {
    ...
    std::cout << "DEBUG: WARNING: x_dot given to CoupledPoissonSchrodingerT evalModel!!" << std::endl;
  }
  ...
  if (W_out != Teuchos::null) { 
    ...
    //  since it includes xdot - maybe need to fabricate this??) and from these construct a CoupledPoissonSchrodingerTJacobian object (an Epetra_Operator)
...
*/
  ...
  for (int i=0; i<outArgs.Np(); i++) {
	...
	TEUCHOS_TEST_FOR_EXCEPTION(true, Teuchos::Exceptions::InvalidParameter,
				   "Error!  QCAD::CoupledPoissonSchrodingerT -- cannot extract dgdp vector view");
...
*/
  ...
  /*if (app->is_adjoint) {  //TODO: support Adjoints?
    TEUCHOS_TEST_FOR_EXCEPTION(true, Teuchos::Exceptions::InvalidParameter,
				   "Error!  QCAD::CoupledPoissonSchrodingerT -- adjoints not implemented yet");
...
QCAD::CoupledPoissonSchrodingerT::getPoissonApp() const
{
  return poissonApp;
}

Teuchos::RCP<Albany::Application>
QCAD::CoupledPoissonSchrodingerT::getSchrodingerApp() const
{
...
/*void QCAD::CoupledPoissonSchrodingerT::separateCombinedVector(const Teuchos::RCP<Epetra_Vector>& combinedVector,
							     ...
							     Teuchos::RCP<Epetra_MultiVector>& schrodinger_part) const
{
  ...
  if(combinedVector->ExtractView(&data) != 0)
    TEUCHOS_TEST_FOR_EXCEPTION(true, Teuchos::Exceptions::InvalidParameter,
			       "Error!  QCAD::CoupledPoissonSchrodingerT cannot extract vector views");
...
void QCAD::CoupledPoissonSchrodingerT::separateCombinedVector(const Teuchos::RCP<const Epetra_Vector>& combinedVector,
...
QCAD::CoupledPoissonSchrodingerT::getValidAppParameters() const
{  
...
Teuchos::RCP<const Teuchos::ParameterList>
QCAD::CoupledPoissonSchrodingerT::getValidProblemParameters() const
{
...
/*void QCAD::CoupledPoissonSchrodingerT::computeResidual(const Teuchos::RCP<const Epetra_Vector>& x,
