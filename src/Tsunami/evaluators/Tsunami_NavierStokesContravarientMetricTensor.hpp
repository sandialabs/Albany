...
#ifndef TSUNAMI_NAVIER_STOKESCONTRAVARIENTMETRICTENSOR_HPP
#define TSUNAMI_NAVIER_STOKESCONTRAVARIENTMETRICTENSOR_HPP
...
class NavierStokesContravarientMetricTensor : 
    public PHX::EvaluatorWithBaseImpl<Traits>,
    public PHX::EvaluatorDerived<EvalT, Traits>  {

public:

  NavierStokesContravarientMetricTensor(const Teuchos::ParameterList& p,
