...
#include "LandIce_EllipticMockModel.hpp"

LandIce::EllipticMockModel::
EllipticMockModel( const Teuchos::RCP<Teuchos::ParameterList>& params_,
...
void LandIce::EllipticMockModel::buildProblem (Teuchos::ArrayRCP<Teuchos::RCP<Albany::MeshSpecsStruct> >  meshSpecs,
  ...
  const Teuchos::RCP<Teuchos::ParameterList>& responseList)
{
  ...
  Albany::ConstructEvaluatorsOp<EllipticMockModel> op(
...
void
LandIce::EllipticMockModel::constructDirichletEvaluators(
        const Albany::MeshSpecsStruct& meshSpecs)
{
...
// Neumann BCs
void LandIce::EllipticMockModel::constructNeumannEvaluators (const Teuchos::RCP<Albany::MeshSpecsStruct>& meshSpecs)
{
...
LandIce::EllipticMockModel::getValidProblemParameters () const
{
  Teuchos::RCP<Teuchos::ParameterList> validPL =
    this->getGenericProblemParams("ValidEllipticMockModelParams");

  validPL->sublist("Elliptic Model", false, "Parameters needed to compute the Elliptic Model");
  ...
  validPL->set<double>("Laplacian Coefficient", 1.0, "Laplacian Coefficient");
  validPL->set<double>("Robin Coefficient", 1.0, "Robin Coefficient");
