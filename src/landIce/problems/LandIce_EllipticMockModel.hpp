...
/*!
 * \brief This class provide a 2d scalar elliptic PDE Elliptic that mimics the nonlinearity present in ice-sheet flow models
and has a reaction term that mimics the basal traction term in ice-flow models:

- div (\alpha |\delta u|^q \delta u) + exp(p) u = f  in \Omega
u = g                                                on \partial Omega

The same problem class can optionally provide the linearization above model at given nominal parameter p_0 and solution u_0.
 */
