...
#define PHAL_INSTANTIATE_TEMPLATE_CLASS_WITH_ONE_EVAL_TYPE_RESIDUAL(name) \
  template class name<PHAL::AlbanyTraits::Residual, PHAL::AlbanyTraits, RealType>;

#if defined(ALBANY_MESH_DEPENDS_ON_SOLUTION)
#define PHAL_INSTANTIATE_TEMPLATE_CLASS_WITH_ONE_EVAL_TYPE_JACOBIAN(name) \
...
#if defined(ALBANY_MESH_DEPENDS_ON_PARAMETERS) || defined(ALBANY_MESH_DEPENDS_ON_SOLUTION)
#define PHAL_INSTANTIATE_TEMPLATE_CLASS_WITH_ONE_EVAL_TYPE_TANGENT(name) \
...
#ifdef ALBANY_ENSEMBLE
#define PHAL_INSTANTIATE_TEMPLATE_CLASS_WITH_ONE_EVAL_TYPE_MPRESIDUAL(name) \
...
#if defined(ALBANY_MESH_DEPENDS_ON_SOLUTION)
#define PHAL_INSTANTIATE_TEMPLATE_CLASS_WITH_ONE_EVAL_TYPE_MPJACOBIAN(name) \
...
#if defined(ALBANY_MESH_DEPENDS_ON_PARAMETERS) || defined(ALBANY_MESH_DEPENDS_ON_SOLUTION)
#define PHAL_INSTANTIATE_TEMPLATE_CLASS_WITH_ONE_EVAL_TYPE_MPTANGENT(name) \
...
#if defined(ALBANY_MESH_DEPENDS_ON_PARAMETERS) || defined(ALBANY_MESH_DEPENDS_ON_SOLUTION)
#define PHAL_INSTANTIATE_TEMPLATE_CLASS_WITH_ONE_EVAL_TYPE_DISTPARAMDERIV(name) \
...
#define PHAL_INSTANTIATE_TEMPLATE_CLASS_WITH_TWO_EVAL_TYPES_RESIDUAL(name) \
...
#ifdef ALBANY_ENSEMBLE
#define PHAL_INSTANTIATE_TEMPLATE_CLASS_WITH_TWO_EVAL_TYPES_MPRESIDUAL(name) \
...
#if defined(ALBANY_MESH_DEPENDS_ON_SOLUTION)
#define PHAL_INSTANTIATE_TEMPLATE_CLASS_WITH_TWO_EVAL_TYPES_MPJACOBIAN(name) \
...
#if defined(ALBANY_MESH_DEPENDS_ON_PARAMETERS) || defined(ALBANY_MESH_DEPENDS_ON_SOLUTION)
#define PHAL_INSTANTIATE_TEMPLATE_CLASS_WITH_TWO_EVAL_TYPES_MPTANGENT(name) \
...
#if defined(ALBANY_MESH_DEPENDS_ON_SOLUTION)
#define PHAL_INSTANTIATE_TEMPLATE_CLASS_WITH_TWO_EVAL_TYPES_JACOBIAN(name) \
...
#if defined(ALBANY_MESH_DEPENDS_ON_PARAMETERS) || defined(ALBANY_MESH_DEPENDS_ON_SOLUTION)
#define PHAL_INSTANTIATE_TEMPLATE_CLASS_WITH_TWO_EVAL_TYPES_TANGENT(name) \
...
#if defined(ALBANY_MESH_DEPENDS_ON_PARAMETERS) || defined(ALBANY_MESH_DEPENDS_ON_SOLUTION)
#define PHAL_INSTANTIATE_TEMPLATE_CLASS_WITH_TWO_EVAL_TYPES_DISTPARAMDERIV(name) \
...
//TODO, ALBANY_SG case.
#ifdef ALBANY_ENSEMBLE
#define PHAL_INSTANTIATE_TEMPLATE_CLASS_WITH_ONE_EVAL_TYPE(name)            \
  PHAL_INSTANTIATE_TEMPLATE_CLASS_WITH_ONE_EVAL_TYPE_RESIDUAL(name)         \
  PHAL_INSTANTIATE_TEMPLATE_CLASS_WITH_ONE_EVAL_TYPE_JACOBIAN(name)         \
  PHAL_INSTANTIATE_TEMPLATE_CLASS_WITH_ONE_EVAL_TYPE_TANGENT(name)          \
  PHAL_INSTANTIATE_TEMPLATE_CLASS_WITH_ONE_EVAL_TYPE_DISTPARAMDERIV(name)   \
  PHAL_INSTANTIATE_TEMPLATE_CLASS_WITH_ONE_EVAL_TYPE_MPRESIDUAL(name)       \
  PHAL_INSTANTIATE_TEMPLATE_CLASS_WITH_ONE_EVAL_TYPE_MPJACOBIAN(name)       \
  PHAL_INSTANTIATE_TEMPLATE_CLASS_WITH_ONE_EVAL_TYPE_MPTANGENT(name)
#else
#define PHAL_INSTANTIATE_TEMPLATE_CLASS_WITH_ONE_EVAL_TYPE(name)            \
  PHAL_INSTANTIATE_TEMPLATE_CLASS_WITH_ONE_EVAL_TYPE_RESIDUAL(name)         \
  PHAL_INSTANTIATE_TEMPLATE_CLASS_WITH_ONE_EVAL_TYPE_JACOBIAN(name)         \
...
#ifdef ALBANY_ENSEMBLE
#define PHAL_INSTANTIATE_TEMPLATE_CLASS_WITH_TWO_EVAL_TYPES(name)            \
  PHAL_INSTANTIATE_TEMPLATE_CLASS_WITH_TWO_EVAL_TYPES_RESIDUAL(name)         \
  PHAL_INSTANTIATE_TEMPLATE_CLASS_WITH_TWO_EVAL_TYPES_JACOBIAN(name)         \
  PHAL_INSTANTIATE_TEMPLATE_CLASS_WITH_TWO_EVAL_TYPES_TANGENT(name)          \
  PHAL_INSTANTIATE_TEMPLATE_CLASS_WITH_TWO_EVAL_TYPES_DISTPARAMDERIV(name)   \
  PHAL_INSTANTIATE_TEMPLATE_CLASS_WITH_TWO_EVAL_TYPES_MPRESIDUAL(name)       \
  PHAL_INSTANTIATE_TEMPLATE_CLASS_WITH_TWO_EVAL_TYPES_MPJACOBIAN(name)       \
  PHAL_INSTANTIATE_TEMPLATE_CLASS_WITH_TWO_EVAL_TYPES_MPTANGENT(name)
#else
#define PHAL_INSTANTIATE_TEMPLATE_CLASS_WITH_TWO_EVAL_TYPES(name)            \
  PHAL_INSTANTIATE_TEMPLATE_CLASS_WITH_TWO_EVAL_TYPES_RESIDUAL(name)         \
  PHAL_INSTANTIATE_TEMPLATE_CLASS_WITH_TWO_EVAL_TYPES_JACOBIAN(name)         \
