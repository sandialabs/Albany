...
#define PHAL_INSTANTIATE_TEMPLATE_CLASS_WITH_EXTRA_ARGS(name,...)                  \
  ...
  PHAL_INSTANTIATE_TEMPLATE_CLASS_WITH_EXTRA_ARGS_MPRESIDUAL(name,__VA_ARGS__)     \
  PHAL_INSTANTIATE_TEMPLATE_CLASS_WITH_EXTRA_ARGS_MPJACOBIAN(name,__VA_ARGS__)     \
  PHAL_INSTANTIATE_TEMPLATE_CLASS_WITH_EXTRA_ARGS_MPTANGENT(name,__VA_ARGS__)
#else
#define PHAL_INSTANTIATE_TEMPLATE_CLASS_WITH_EXTRA_ARGS(name,...)                  \
  PHAL_INSTANTIATE_TEMPLATE_CLASS_WITH_EXTRA_ARGS_RESIDUAL(name,__VA_ARGS__)       \
  PHAL_INSTANTIATE_TEMPLATE_CLASS_WITH_EXTRA_ARGS_JACOBIAN(name,__VA_ARGS__)       \
