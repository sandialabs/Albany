...
template<class SizeField>
bool
AAdapt::STKAdaptT<SizeField>::queryAdaptationCriteria(int iteration) {
...
template<class SizeField>
void
AAdapt::STKAdaptT<SizeField>::printElementData() {
...
template<class SizeField>
bool
AAdapt::STKAdaptT<SizeField>::adaptMesh(const Teuchos::RCP<const Tpetra_Vector>& solution,
...
AAdapt::STKAdaptT<SizeField>::getValidAdapterParameters() const {
