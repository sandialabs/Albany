...
// Default constructor
//
RandomCriterion::RandomCriterion(int num_dim, Albany::STKDiscretization& stk)
    : AbstractFailureCriterion(num_dim, stk::topology::ELEMENT_RANK), stk_(stk)
{
}
