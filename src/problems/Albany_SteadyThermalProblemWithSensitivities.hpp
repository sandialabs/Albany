...
#ifndef ALBANY_STEADYTHERMALPROBLEMWITHSENSITIVITIES_HPP
#define ALBANY_STEADYTHERMALPROBLEMWITHSENSITIVITIES_HPP
...
namespace Albany {
   ...
   * problem.
   */
  class SteadyThermalProblemWithSensitivities : public AbstractProblem {
  public:

    //! Default constructor
    SteadyThermalProblemWithSensitivities(
  ...
  private:
    ...
    SteadyThermalProblemWithSensitivities(const SteadyThermalProblemWithSensitivities&);

    //! Private to prohibit copying
    SteadyThermalProblemWithSensitivities& operator=(const SteadyThermalProblemWithSensitivities&);
...
#include "PHAL_SteadyThermalResidWithSensitivities.hpp"


template <typename EvalT>
Teuchos::RCP<const PHX::FieldTag>
Albany::SteadyThermalProblemWithSensitivities::constructEvaluators(
  PHX::FieldManager<PHAL::AlbanyTraits>& fm0,
  const Albany::MeshSpecsStruct& meshSpecs,
  Albany::StateManager& stateMgr,
  ...
  const Teuchos::RCP<Teuchos::ParameterList>& responseList)
{
  ...
  ALBANY_PANIC(
      ...
      "Albany_SteadyThermalProblemWithSensitivities must be defined as steady "
      "calculation.");
  ...
  *out << "Field Dimensions: Workset=" << worksetSize
  ...
  {  // Temperature Resid
    ...
    ev = rcp(new PHAL::SteadyThermalResidWithSensitivities<EvalT, AlbanyTraits>(*p));
