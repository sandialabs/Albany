...
#ifndef ALBANY_ADVECTIONPROBLEM_HPP
#define ALBANY_ADVECTIONPROBLEM_HPP
  ...
  const Teuchos::RCP<Teuchos::ParameterList>& responseList)
{
  ...
  *out << "Field Dimensions: Workset=" << worksetSize
  ...
  if (!advectionIsDistParam) {  
    ...
    RCP<PHAL::SharedParameter<EvalT,PHAL::AlbanyTraits,Albany::ParamEnum>> ptr_a_x;
    ptr_a_x = rcp(new PHAL::SharedParameter<EvalT,PHAL::AlbanyTraits,Albany::ParamEnum>(*p,dl));
    ...
    if (numDim > 1) {  //Shared parameter for sensitivity analysis: a_y
      ...
      RCP<PHAL::SharedParameter<EvalT,PHAL::AlbanyTraits,Albany::ParamEnum>> ptr_a_y;
      ptr_a_y = rcp(new PHAL::SharedParameter<EvalT,PHAL::AlbanyTraits,Albany::ParamEnum>(*p,dl));
    ...
    if (numDim > 2) {  //Shared parameter for sensitivity analysis: a_z
      ...
      RCP<PHAL::SharedParameter<EvalT,PHAL::AlbanyTraits,Albany::ParamEnum>> ptr_a_z;
      ptr_a_z = rcp(new PHAL::SharedParameter<EvalT,PHAL::AlbanyTraits,Albany::ParamEnum>(*p,dl));
