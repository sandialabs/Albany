...
namespace Albany {
  ...
  struct Layouts {
    ...
    Layouts (int worksetSize, int numVertices, int numNodes, int numQPts, int numSideDim, int numSpaceDim, int numSides, int vecDim, bool singleWorksetSizeAllocation=false, int sidesetWorksetSize=1, std::string sideSetName="");
