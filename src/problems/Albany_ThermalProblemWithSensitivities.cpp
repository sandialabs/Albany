...
Albany::ThermalProblemWithSensitivities::
ThermalProblemWithSensitivities( const Teuchos::RCP<Teuchos::ParameterList>& params_,
  ...
  const Teuchos::RCP<Teuchos::ParameterList>& responseList)
{
  ...
  ConstructEvaluatorsOp<ThermalProblemWithSensitivities> op(
...
// Dirichlet BCs
void
Albany::ThermalProblemWithSensitivities::constructDirichletEvaluators(const std::vector<std::string>& nodeSetIDs)
{
...
// Neumann BCs
void
Albany::ThermalProblemWithSensitivities::constructNeumannEvaluators(const Teuchos::RCP<Albany::MeshSpecsStruct>& meshSpecs)
{
...
Albany::ThermalProblemWithSensitivities::getValidProblemParameters() const
{
  Teuchos::RCP<Teuchos::ParameterList> validPL =
    this->getGenericProblemParams("ValidThermalProblemWithSensitivitiesParams");
