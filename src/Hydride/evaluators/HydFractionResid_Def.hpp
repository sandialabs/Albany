...
evaluateFields(typename Traits::EvalData workset)
{
  ...
  */
  ...
  FST::integrate(FhResidual, JGrad, wGradBF, false); // "false" overwrites
  ...
  */
    ...
    FST::integrate(FhResidual, fh_time_term, wBF, true); // "true" sums into
  ...
  */
    ...
    FST::integrate(FhResidual, CH_time_term, wBF, true); // "true" sums into
