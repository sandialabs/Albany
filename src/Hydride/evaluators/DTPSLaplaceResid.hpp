...
#ifndef DTPSLAPLACERESID_HPP
#define DTPSLAPLACERESID_HPP
...
class DTPSLaplaceResid : public PHX::EvaluatorWithBaseImpl<Traits>,
  public PHX::EvaluatorDerived<EvalT, Traits>  {

  public:

    DTPSLaplaceResid(const Teuchos::ParameterList& p,
  ...
  private:
    ...
    Intrepid::FieldContainer<ScalarT> x;

    // Output:
    PHX::MDField<ScalarT, Cell, Node, Dim> dispResidual;
