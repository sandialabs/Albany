...
#ifndef AERAS_SHALLOWWATERPROBLEM_NOAD_HPP
#define AERAS_SHALLOWWATERPROBLEM_NOAD_HPP
...
namespace Aeras {
   ...
   * problem.
   */
  class ShallowWaterProblemNoAD : public Albany::AbstractProblem {
  public:
  
    //! Default constructor
    ShallowWaterProblemNoAD(const Teuchos::RCP<Teuchos::ParameterList>& params,
  ...
  private:
    ...
    ShallowWaterProblemNoAD(const ShallowWaterProblemNoAD&);
    
    //! Private to prohibit copying
    ShallowWaterProblemNoAD& operator=(const ShallowWaterProblemNoAD&);
...
#include "Aeras_SW_ComputeAndScatterJac.hpp"

#include "Aeras_ComputeBasisFunctions.hpp"
#include "Aeras_GatherCoordinateVector.hpp"
template <typename EvalT>
Teuchos::RCP<const PHX::FieldTag>
Aeras::ShallowWaterProblemNoAD::constructEvaluators(
  PHX::FieldManager<PHAL::AlbanyTraits>& fm0,
  const Albany::MeshSpecsStruct& meshSpecs,
  Albany::StateManager& stateMgr,
