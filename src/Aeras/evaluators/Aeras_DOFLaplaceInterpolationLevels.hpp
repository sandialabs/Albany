...
/** \brief Finite Element Interpolation Evaluator
    ...
    Laplace at quad points.

*/

template<typename EvalT, typename Traits>
class DOFLaplaceInterpolationLevels : public PHX::EvaluatorWithBaseImpl<Traits>,
...
private:
  ...
  PHX::MDField<ScalarT,Cell,QuadPoint,Level> Laplace_val_qp;
