...
private:
  ...
  PHX::MDField<ScalarT,Cell,QuadPoint,VecDim> force;
   ...
   //Radom field types
  enum BFTYPE {NONE, POISSON, FO_SINCOS2D, FO_COSEXP2D, FO_COSEXP2DFLIP, FO_COSEXP2DALL, FO_SINCOSZ, FO_SINEXP2D, FO_ISMIPHOM_TESTA, FO_ISMIPHOM_TESTC, FO_ISMIPHOM_TESTD};
  BFTYPE bf_type;
