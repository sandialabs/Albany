...
#ifndef FELIX_HYDROLOGY_RESIDUAL_TILL_STORAGE_EQN_HPP
#define FELIX_HYDROLOGY_RESIDUAL_TILL_STORAGE_EQN_HPP 1
...
#endif // FELIX_HYDROLOGY_RESIDUAL_TILL_STORAGE_EQN_HPP
