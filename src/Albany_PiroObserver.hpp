...
private:
  ...
  void observeSolutionImpl (const Teuchos::RCP<Thyra_Vector>& x,
                            const Teuchos::RCP<Thyra_Vector>& x_dot,
                            const Teuchos::RCP<Thyra_Vector>& x_dotdot,
                            const Teuchos::RCP<Thyra_MultiVector>& dxdp,
                            const ST defaultStamp);

  void observeSolutionImpl(const Thyra_MultiVector& x,
                          const ST defaultStamp);
