...
//*****************************************************************//
#include "LinearElasticityModalProblem.hpp"
#include "Albany_Utils.hpp"
#include "Albany_ProblemUtils.hpp"
#include "ATO_TopoTools.hpp"

Albany::LinearElasticityModalProblem::
LinearElasticityModalProblem(const Teuchos::RCP<Teuchos::ParameterList>& params_,
  ...
  Albany::StateManager& stateMgr)
{
  ...
  *out << "Calling LinearElasticityModalProblem::buildEvaluators" << '\n';
  ...
  const Teuchos::RCP<Teuchos::ParameterList>& responseList)
{
  ...
  ConstructEvaluatorsOp<LinearElasticityModalProblem> op(
...
// Dirichlet BCs
void
Albany::LinearElasticityModalProblem::constructDirichletEvaluators(
        const Albany::MeshSpecsStruct& meshSpecs)
{
...
// Neumann BCs
void
Albany::LinearElasticityModalProblem::constructNeumannEvaluators(
...
Albany::LinearElasticityModalProblem::getValidProblemParameters() const
{
  Teuchos::RCP<Teuchos::ParameterList> validPL =
    this->getGenericProblemParams("ValidLinearElasticityModalProblemParams");
