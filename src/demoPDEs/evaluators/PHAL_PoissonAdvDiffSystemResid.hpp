...
#ifndef PHAL_POISSONADVDIFFSYSTEMRESID_HPP
#define PHAL_POISSONADVDIFFSYSTEMRESID_HPP
...
class PoissonAdvDiffSystemResid : public PHX::EvaluatorWithBaseImpl<Traits>,
