...
#ifndef AMPTHERMOMECHANICS_HPP
#define AMPTHERMOMECHANICS_HPP
...
///
class AMPThermoMechanics : public AbstractProblem
{
public:
 
  AMPThermoMechanics(const Teuchos::RCP<Teuchos::ParameterList>& params,
...
private:
  ...
  AMPThermoMechanics(const AMPThermoMechanics&);
    
  AMPThermoMechanics& operator=(const AMPThermoMechanics&);
...
template <typename EvalT>
Teuchos::RCP<const PHX::FieldTag>
Albany::AMPThermoMechanics::constructEvaluators(
  PHX::FieldManager<PHAL::AlbanyTraits>& fm0,
  const Albany::MeshSpecsStruct& meshSpecs,
  Albany::StateManager& stateMgr,
