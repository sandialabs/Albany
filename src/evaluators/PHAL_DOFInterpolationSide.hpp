...
private:
  ...
  PHX::MDField<ParamScalarT,Side,Cell,QuadPoint> val_qp;
...
template<typename EvalT, typename Traits>
class DOFInterpolationSideParam : public DOFInterpolationSideBase<EvalT, Traits, typename EvalT::ParamScalarT>
{
public:
