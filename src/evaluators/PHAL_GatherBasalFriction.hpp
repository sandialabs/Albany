...
#ifndef PHAL_GATHER_BASALFRCTION_HPP
#define PHAL_GATHER_BASALFRCTION_HPP
...
class GatherBasalFriction : public PHX::EvaluatorWithBaseImpl<Traits>,
...
private:
  ...
  PHX::MDField<ScalarT,Cell,Vertex> basalFriction;
