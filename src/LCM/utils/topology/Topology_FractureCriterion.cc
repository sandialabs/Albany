    ...
    case 2:
      {
        ...
        Intrepid::Index const
        lid0 = stk_discretization_.getNodeMapT()->getLocalElement(gid0);
        ...
        Intrepid::Index const
        lid1 = stk_discretization_.getNodeMapT()->getLocalElement(gid1);
    ...
    case 3:
      {
        ...
        Intrepid::Index const
        lid2 = stk_discretization_.getNodeMapT()->getLocalElement(gid2);
