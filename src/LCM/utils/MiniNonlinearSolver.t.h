...
MiniSolver<MIN, STEP, FN, PHAL::AlbanyTraits::Residual, N>::MiniSolver(
    MIN&                                                          minimizer,
    STEP&                                                         step_method,
    FN&                                                           function,
...
template <typename MIN, typename STEP, typename FN, minitensor::Index N>
MiniSolver<MIN, STEP, FN, PHAL::AlbanyTraits::Jacobian, N>::MiniSolver(
    MIN&                                                          minimizer,
    STEP&                                                         step_method,
    FN&                                                           function,
...
MiniSolverROL<MIN, FN, PHAL::AlbanyTraits::Residual, N>::MiniSolverROL(
    MIN&                    minimizer,
    std::string const&      algoname,
    Teuchos::ParameterList& params,
    FN&                     function,
...
template <typename MIN, typename FN, minitensor::Index N>
MiniSolverROL<MIN, FN, PHAL::AlbanyTraits::Jacobian, N>::MiniSolverROL(
    MIN&                    minimizer,
    std::string const&      algoname,
    Teuchos::ParameterList& params,
    FN&                     function,
...
template <
    ...
    typename EvalT,
    minitensor::Index N>
MiniSolverBoundsROL<MIN, FN, BC, EvalT, N>::MiniSolverBoundsROL(
    MIN&                                            minimizer,
    std::string const&                              algoname,
    Teuchos::ParameterList&                         params,
    FN&                                             function,
...
template <
    ...
    minitensor::Index N,
    minitensor::Index NC>
MiniSolverEqIneqROL<MIN, FN, EIC, EvalT, N, NC>::MiniSolverEqIneqROL(
    MIN&                                             minimizer,
    std::string const&                               algoname,
    Teuchos::ParameterList&                          params,
    FN&                                              function,
            ...
            cv)
{
  ...
  minitensor::Vector<ValueT, NC> cv_val =
      Sacado::Value<minitensor::Vector<T, NC>>::eval(cv);
    ...
    minitensor::Vector<T, N>&       x)
{
  ...
  auto const dimension = r.get_dimension();

  if (0 == dimension) return;

  auto const order = r[0].size();
  ...
  // Solve for all DxDp
  minitensor::Matrix<S, N, minitensor::DYNAMIC> DxDp =
      minitensor::solve(DrDx, DrDp);
