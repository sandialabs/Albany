...
public:
  ...
  */
  ...
  FunctionT(const FunctionT<traits>& old) :
...
//  MoertelT::FunctionT<traits>::traits_type Type() const { return type_;}
  ...
  */
  void EvaluateFunction(const double* xi, double* val, const int valdim, double* deriv){
...
*/
  ...
  struct Constant1D {
    ...
    static void EvaluateFunction(const double* xi, double* val, const int valdim, double* deriv){
