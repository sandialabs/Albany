...
//  friend class IntegratorT<ST, LO, GO, N>;
  ...
  */
  Teuchos::RCP<MoertelT::MOERTEL_TEMPLATE_CLASS(NodeT) > GetNodeView(int nid);
  ...
  */
  bool GetNodeView(std::vector<MoertelT::MOERTEL_TEMPLATE_CLASS(NodeT)*>& nodes);
  ...
  */
  Teuchos::RCP<MoertelT::SEGMENT_TEMPLATE_CLASS(SegmentT) > GetSegmentView(int sid);
  ...
  */
  ...
  \return True if successful, false otherwise
  */
  bool AddSegment(MoertelT::SEGMENT_TEMPLATE_CLASS(SegmentT)& seg, int side);
  ...
  \return True if successful, false otherwise
  */
  bool AddNode(MoertelT::MOERTEL_TEMPLATE_CLASS(NodeT)& node, int side);
  ...
  */
  ...
  \return True if successful, false otherwise
  */
//  bool SetFunctionAllSegmentsSide(int side, int id, MoertelT::MOERTEL_TEMPLATE_CLASS(FunctionT)* func);
  ...
  */
  void SetProjectionType(MoertelT::MOERTEL_TEMPLATE_CLASS(InterfaceT)::ProjectionType typ) { ptype_ = typ; } 
  ...
  */
  bool SetFunctionTypes(MoertelT::MOERTEL_TEMPLATE_CLASS(FunctionT)::FunctionType primal,
...
private:  
  ...
  Teuchos::RCP<MoertelT::MOERTEL_TEMPLATE_CLASS(NodeT) > GetNodeViewLocal(int nid);
...
//                            Tpetra_CrsMatrix& M,Tpetra_CrsMatrix& D);
  bool Integrate_2D_Section(MoertelT::SEGMENT_TEMPLATE_CLASS(SegmentT)& sseg, 
  ...
  bool Integrate_3D_Section(MoertelT::SEGMENT_TEMPLATE_CLASS(SegmentT)& sseg, 
       MoertelT::SEGMENT_TEMPLATE_CLASS(SegmentT)& mseg);
  ...
  bool QuickOverlapTest_2D(MoertelT::SEGMENT_TEMPLATE_CLASS(SegmentT)& sseg, 
       MoertelT::SEGMENT_TEMPLATE_CLASS(SegmentT)& mseg);
...
// Now, the explicit template function declarations (templated on dimension)
  ...
  bool MoertelT::InterfaceT<2, ST, LO, GO, N>::Mortar_Integrate_2D(Teuchos::RCP<Teuchos::ParameterList> intparams);
