      ...
      std::map<int,Teuchos::RCP<MoertelT::MOERTEL_TEMPLATE_CLASS(PointT) > >& p)
{
  ...
  std::vector<Teuchos::RCP<MoertelT::MOERTEL_TEMPLATE_CLASS(PointT) > > points; PointView(p,points);
 ...
 *----------------------------------------------------------------------*/
MOERTEL_TEMPLATE_STATEMENT_1A(class IFace)
bool MoertelT::MOERTEL_TEMPLATE_CLASS_1A(OverlapT, IFace)::MakeRightTurnUpper(int i,
 ...
 *----------------------------------------------------------------------*/
MOERTEL_TEMPLATE_STATEMENT_1A(class IFace)
bool MoertelT::MOERTEL_TEMPLATE_CLASS_1A(OverlapT, IFace)::MakeRightTurnLower(int i,
     std::map<int,Teuchos::RCP<MoertelT::MOERTEL_TEMPLATE_CLASS(PointT) > >& hull)
{
  // note:
  // point i for sure exists as it was added as last point
 ...
 *----------------------------------------------------------------------*/
MOERTEL_TEMPLATE_STATEMENT_1A(class IFace)
void MoertelT::MOERTEL_TEMPLATE_CLASS_1A(OverlapT, IFace)::RemovePointBefore(int i,
     std::map<int,Teuchos::RCP<MoertelT::MOERTEL_TEMPLATE_CLASS(PointT) > >& hull)
{
  // note:
  // point i for sure exists as it was added as last point
 ...
 *----------------------------------------------------------------------*/
MOERTEL_TEMPLATE_STATEMENT_1A(class IFace)
void MoertelT::MOERTEL_TEMPLATE_CLASS_1A(OverlapT, IFace)::RemovePointAfter(int i,
      std::map<int,Teuchos::RCP<MoertelT::MOERTEL_TEMPLATE_CLASS(PointT) > >& hull)
{
  // note:
  // point i for sure exists as it was added as last point
...
bool MoertelT::MOERTEL_TEMPLATE_CLASS_1A(OverlapT, IFace)::CollapsePoints(
      std::map<int,Teuchos::RCP<MoertelT::MOERTEL_TEMPLATE_CLASS(PointT) > >& p, const double eps)
{
