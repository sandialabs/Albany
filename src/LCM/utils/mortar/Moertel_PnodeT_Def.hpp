...
MoertelT::MOERTEL_TEMPLATE_CLASS(ProjectedNodeT)::ProjectedNodeT(const MoertelT::MOERTEL_TEMPLATE_CLASS(NodeT)& basenode, 
                                   const double* xi, 
                                   MoertelT::MOERTEL_TEMPLATE_CLASS(SegmentT)* pseg) :
MoertelT::MOERTEL_TEMPLATE_CLASS(NodeT)(basenode),
orthseg_(-1)
{
  pseg_ = pseg;
  if (xi)
 ...
 *----------------------------------------------------------------------*/
MOERTEL_TEMPLATE_STATEMENT
Moertel::MOERTEL_TEMPLATE_CLASS(ProjectedNodeT)::ProjectedNodeT(const MoertelT::MOERTEL_TEMPLATE_CLASS(NodeT)& basenode, 
                                   const double* xi, 
                                   MoertelT::MOERTEL_TEMPLATE_CLASS(SegmentT)* pseg,
                                   int orthseg) :
MoertelT::MOERTEL_TEMPLATE_CLASS(NodeT)(basenode),
 ...
 *----------------------------------------------------------------------*/
MOERTEL_TEMPLATE_STATEMENT
std::ostream& operator << (std::ostream& os, const MoertelT::MOERTEL_TEMPLATE_CLASS(ProjectedNodeT)& pnode)
{ 
  pnode.Print();
  return (os);
}
