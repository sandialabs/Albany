...
MoertelT::MOERTEL_TEMPLATE_CLASS_1A(OverlapT, IFace)::OverlapT(MoertelT::SEGMENT_TEMPLATE_CLASS(SegmentT)& sseg, 
...
MOERTEL_TEMPLATE_STATEMENT_1A(class IFace)
bool MoertelT::MOERTEL_TEMPLATE_CLASS_1A(OverlapT, IFace)::buildPoly(std::vector<double>& source_xi, std::vector<double>& source_eta,
...
bool MoertelT::MOERTEL_TEMPLATE_CLASS_1A(OverlapT, IFace)::Triangulation()
{
  ...
  {
    double xi[2];
    std::vector<Teuchos::RCP<MoertelT::MOERTEL_TEMPLATE_CLASS(PointT) > > points; PointView(points);
