...
operator<<(
    std::ostream&                                            os,
    const MoertelT::UtilsT<3, double, int, int, KokkosNode>& inter);
template std::ostream&
operator<<(
    std::ostream&                                            os,
    const MoertelT::UtilsT<2, double, int, int, KokkosNode>& inter);
#endif
#ifdef HAVE_MOERTEL_INST_DOUBLE_INT_LONGLONGINT
template std::ostream&
operator<<(
    std::ostream&                                                  os,
    const MoertelT::UtilsT<3, double, int, long long, KokkosNode>& inter);
template std::ostream&
operator<<(
    std::ostream&                                                  os,
    const MoertelT::UtilsT<2, double, int, long long, KokkosNode>& inter);
#endif
