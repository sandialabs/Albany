...
public:
  ...
  */
  Teuchos::SerialDenseMatrix<LO, ST>* Integrate(MoertelT::SEGMENT_TEMPLATE_CLASS(SegmentT)& sseg, double sxia, double sxib,
                                      MoertelT::SEGMENT_TEMPLATE_CLASS(SegmentT)& mseg, double mxia, double mxib);
  ...
  */
  bool Assemble(MoertelT::MOERTEL_TEMPLATE_CLASS(InterfaceT)& inter, MoertelT::SEGMENT_TEMPLATE_CLASS(SegmentT)& sseg, 
  ...
  */
  bool Assemble(MoertelT::MOERTEL_TEMPLATE_CLASS(InterfaceT)& inter, 
                MoertelT::SEGMENT_TEMPLATE_CLASS(SegmentT)& sseg,  MoertelT::SEGMENT_TEMPLATE_CLASS(SegmentT)& mseg,
                Tpetra::CrsMatrix<ST, LO, GO, N>& D, Teuchos::SerialDenseMatrix<LO, ST>& Ddense);
  ...
  \param mxib : upper bound of overlap in mortar segment coordinates
  */
  Teuchos::SerialDenseMatrix<LO, ST>* Integrate_2D_Mmod(MoertelT::SEGMENT_TEMPLATE_CLASS(SegmentT)& sseg, 
...
#endif
  bool Assemble_2D_Mod(MoertelT::MOERTEL_TEMPLATE_CLASS(InterfaceT)& inter, 
                       MoertelT::SEGMENT_TEMPLATE_CLASS(SegmentT)& sseg, MoertelT::SEGMENT_TEMPLATE_CLASS(SegmentT)& mseg, 
  ...
  */
  bool Integrate(Teuchos::RCP<MoertelT::SEGMENT_TEMPLATE_CLASS(SegmentT) > actseg,
  ...
  */
  bool Assemble(MoertelT::MOERTEL_TEMPLATE_CLASS(InterfaceT)& inter,
     MoertelT::SEGMENT_TEMPLATE_CLASS(SegmentT)& sseg,Teuchos::SerialDenseMatrix<LO, ST>& Ddense);
...
private:  
  // don't want = operator
  IntegratorT operator = (const MOERTEL_TEMPLATE_CLASS(IntegratorT)& old);
