...
SEGMENT_TEMPLATE_STATEMENT
MoertelT::SEGMENT_TEMPLATE_CLASS(SegmentT)::Segment(int id, const std::vector<int>& nodev, int outlevel) :
Id_(id),
outputlevel_(outlevel),
stype_(MoertelT::SEGMENT_TEMPLATE_CLASS(SegmentT)::seg_none),
nodeId_(nodev)
 ...
 *----------------------------------------------------------------------*/
SEGMENT_TEMPLATE_STATEMENT
bool MoertelT::SEGMENT_TEMPLATE_CLASS(SegmentT)::EvaluateFunction(int id, const double* xi, double* val, 
...
{ 
  ...
  {
	std::stringstream oss;
		oss << "***ERR*** MoertelT::MOERTEL_TEMPLATE_CLASS(SegmentT)::EvaluateFunction:\n"
 ...
 *----------------------------------------------------------------------*/
SEGMENT_TEMPLATE_STATEMENT
bool MoertelT::SEGMENT_TEMPLATE_CLASS(SegmentT)::GetPtrstoNodes(MoertelT::SEGMENT_TEMPLATE_CLASS(InterfaceT)& interface)
{ 
 ...
 *----------------------------------------------------------------------*/
SEGMENT_TEMPLATE_STATEMENT
bool MoertelT::SEGMENT_TEMPLATE_CLASS(SegmentT)::GetPtrstoNodes(std::vector<MoertelT::SEGMENT_TEMPLATE_CLASS(NodeT)*>& nodes)
{ 
  if (!nodeId_.size()) return false;
...
template
bool MoertelT::SEGMENT_TEMPLATE_CLASS(SegmentT)::GetPtrstoNodes<double, int, int, KokkosNode>
      (MoertelT::InterfaceT<double, int, int, KokkosNode>& interface);
#endif
#ifdef HAVE_MOERTEL_INST_DOUBLE_INT_LONGLONGINT
template
bool MoertelT::SEGMENT_TEMPLATE_CLASS(SegmentT)::GetPtrstoNodes<double, int, long long, KokkosNode>
