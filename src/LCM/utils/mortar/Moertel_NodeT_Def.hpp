 ...
 *----------------------------------------------------------------------*/
MOERTEL_TEMPLATE_STATEMENT
bool MoertelT::MOERTEL_TEMPLATE_CLASS(NodeT)::GetPtrstoSegments(MoertelT::MOERTEL_TEMPLATE_CLASS(InterfaceT)& interface)
{ 
 ...
 *----------------------------------------------------------------------*/
MOERTEL_TEMPLATE_STATEMENT
Teuchos::RCP<MoertelT::MOERTEL_TEMPLATE_CLASS(ProjectedNodeT) >* MoertelT::MOERTEL_TEMPLATE_CLASS(NodeT)::GetProjectedNode(int& length)
{ 
  length = pnode_.size();
  if (length)
    return &(pnode_[0]);
 ...
 *----------------------------------------------------------------------*/
MOERTEL_TEMPLATE_STATEMENT
Teuchos::RCP<MoertelT::MOERTEL_TEMPLATE_CLASS(ProjectedNodeT) > MoertelT::MOERTEL_TEMPLATE_CLASS(NodeT)::GetProjectedNode()
{ 
...
template
bool MoertelT::NodeT<3, double, int, int, KokkosNode>::GetPtrstoSegments<double, int, int, KokkosNode>
      (MoertelT::InterfaceT<double, int, int, KokkosNode>& interface);
template
bool MoertelT::NodeT<2, double, int, int, KokkosNode>::GetPtrstoSegments<double, int, int, KokkosNode>
      (MoertelT::InterfaceT<double, int, int, KokkosNode>& interface);
#endif
#ifdef HAVE_MOERTEL_INST_DOUBLE_INT_LONGLONGINT
template
bool MoertelT::NodeT<3, double, int, long long, KokkosNode>::GetPtrstoSegments<double, int, long long, KokkosNode>
      (MoertelT::InterfaceT<double, int, long long, KokkosNode>& interface);
template
bool MoertelT::NodeT<2, double, int, long long, KokkosNode>::GetPtrstoSegments<double, int, long long, KokkosNode>
      (MoertelT::InterfaceT<double, int, long long, KokkosNode>& interface);
#endif
