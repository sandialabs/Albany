    ...
    Teuchos::RCP<Tpetra_Vector const> const & initial_guessT)
{
  ...
  //FIXME: define coupled_disc_map, a map for the entire coupled ME
  //solution, created from the entries of the disc_map array
  //(individual maps).  coupled_disc_map_ = ...  (write separate
  //function to compute this map?)
