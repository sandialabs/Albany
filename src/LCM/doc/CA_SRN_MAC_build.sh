...
echo " update DYLD_LIBRARY_PATH for soon to be installed libs"
export DYLD_LIBRARY_PATH=$INSTALL_DIR/lib:$DYLD_LIBRARY_PATH
export DYLD_LIBRARY_PATH=$INSTALL_DIR/lib64:$DYLD_LIBRARY_PATH
...
echo " export DYLD_LIBRARY_PATH=$INSTALL_DIR/lib64:\$DYLD_LIBRARY_PATH"
