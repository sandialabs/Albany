...
\begin{figure}[htbp]
  \begin{center}
    \unitlength=1.0mm
    \subfigure[]{
      \includegraphics[width=120mm]{RefinementF.eps}}
    \subfigure[]{
      \includegraphics[width=120mm]{RefinementR.eps}}
      \subfigure[]{
      \includegraphics[width=120mm]{RefinementU.eps}}
