...
to handle interpolation of tensor field. An $L \times 0.1 L \times 0.1 L$ 
...
\begin{figure}[htbp]
  \begin{center}
    \unitlength=1.0mm
    \subfigure[]{
      \includegraphics[width=80mm]{RingProjOnly.png}}
    \subfigure[]{
      \includegraphics[width=80mm]{RingProjLie.png}}
    ...
    (a) polynomial interpolation without Lie Algebra and (b) polynomial interpolation with Lie Algebra.}
    \label{fig:ExampleRing}
  \end{center}
\end{figure}

Alternatively, the overall accuracy of the interpolation can be assessed 
by computing the error over the entire domain, i.e., 
\begin{equation}
