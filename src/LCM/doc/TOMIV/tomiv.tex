...
load-deflection curves. Both results obtained from 8-node and 27-node element are  in good agreement with 
...
to directly project $\bF^{p}$ from Gauss points to nodal points for
interpolations. This spurious volumetric plastic deformation caused by 
inappropriate projection is depicted in Figures \ref{fig:BilletNOLie}(a) and (b).
