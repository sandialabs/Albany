...
SurfaceScalarGradientOperatorPorePressure<EvalT, Traits>::SurfaceScalarGradientOperatorPorePressure(
          ...
          dl->qp_gradient)
{
  ...
  this->setName(
      "Surface Scalar Gradient Operator Pore Pressure" + PHX::typeAsString<EvalT>());
  ...
  std::cout << "in Surface Scalar Gradient Operator Pore Pressure" << std::endl;
...
template <typename EvalT, typename Traits>
void
SurfaceScalarGradientOperatorPorePressure<EvalT, Traits>::evaluateFields(
