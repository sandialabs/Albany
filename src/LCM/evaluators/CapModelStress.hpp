...
private:
  ...
  ScalarT compute_f(LCM::Tensor<ScalarT> & sigma, LCM::Tensor<ScalarT> & alpha, ScalarT & kappa);

  LCM::Tensor<ScalarT> compute_dfdsigma(LCM::Tensor<ScalarT> & sigma, LCM::Tensor<ScalarT> & alpha, ScalarT & kappa);

  LCM::Tensor<ScalarT> compute_dgdsigma(LCM::Tensor<ScalarT> & sigma, LCM::Tensor<ScalarT> & alpha, ScalarT & kappa);

  ScalarT compute_dfdkappa(LCM::Tensor<ScalarT> & sigma, LCM::Tensor<ScalarT> & alpha, ScalarT & kappa);

  ScalarT compute_Galpha(ScalarT & J2_alpha);

  LCM::Tensor<ScalarT> compute_halpha(LCM::Tensor<ScalarT> & dgdsigma, ScalarT & J2_alpha);
