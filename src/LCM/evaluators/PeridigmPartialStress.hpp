//*****************************************************************//
//    Albany 2.0:  Copyright 2014 Sandia Corporation               //
...
// Inherted classes 
template<typename EvalT, typename Traits> class PeridigmPartialStress;
...
class PeridigmPartialStress<PHAL::AlbanyTraits::Residual, Traits> : public PeridigmPartialStressBase<PHAL::AlbanyTraits::Residual, Traits> {
public:
  PeridigmPartialStress(Teuchos::ParameterList& p)
