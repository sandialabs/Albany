      ...
      p.get<Teuchos::RCP<PHX::DataLayout> >("QP Scalar Data Layout"))
{
  ...
  if (type == "Constant") {
    ...
    new Sacado::ParameterRegistration<EvalT, SPL_Traits>("Poissons Ratio", this, paramLib);
  }
  ...
  if ( p.isType<std::string>("QP Temperature Name") ) {
    ...
    new Sacado::ParameterRegistration<EvalT, SPL_Traits>("dnudT Value", this, paramLib);
  }
  else {
