...
//*****************************************************************//
#include "ConcurrentMultiscale.hpp"
  ...
  num_dims_(num_dims)
{
  ...
  *out << "Problem Name = " << method << '\n';
  ...
  TEUCHOS_TEST_FOR_EXCEPTION(
      invalid_material_DB,
      std::logic_error,
      "ConcurrentMultiscale Requires a Material Database"
  );
    ...
    Albany::StateManager & state_mgr)
{
  ...
  std::cout << "Calling ConcurrentMultiscale::buildEvaluators" << '\n';
    ...
    Teuchos::RCP<Teuchos::ParameterList> const & response_list)
{
  ...
  ConstructEvaluatorsOp<ConcurrentMultiscale> 
    op(
        *this,
        fm0,
        mesh_specs,
...
getValidProblemParameters() const
{
  Teuchos::RCP<Teuchos::ParameterList> valid_pl =
    this->getGenericProblemParams("ValidConcurrentMultiscaleParams");
