...
//	  p->set<string>("Biot Coefficient Name", "Biot Coefficient");
   ...
   { // Biot Modulus
   	  ...
   	  p->set<string>("Porosity Name", "Porosity");
          ...
          fm0.template registerEvaluator<EvalT>(ev);
          p = stateMgr.registerStateVariable("Biot Modulus",dl->qp_scalar, dl->dummy,"scalar", 1000000.0);
          ev = rcp(new PHAL::SaveStateField<EvalT,AlbanyTraits>(*p));
          fm0.template registerEvaluator<EvalT>(ev);
     }
  ...
  { // Van Genuchten Permeaiblity
     ...
     fm0.template registerEvaluator<EvalT>(ev);
     p = stateMgr.registerStateVariable("Van Genuchten Permeability",dl->qp_scalar, dl->dummy,"scalar", 0.0);
     ev = rcp(new PHAL::SaveStateField<EvalT,AlbanyTraits>(*p));
     fm0.template registerEvaluator<EvalT>(ev);
    }
  ...
  { // Van Genuchten Saturation
       ...
       fm0.template registerEvaluator<EvalT>(ev);
       p = stateMgr.registerStateVariable("Van Genuchten Saturation",dl->qp_scalar, dl->dummy,"scalar", 0.0, true);
       ev = rcp(new PHAL::SaveStateField<EvalT,AlbanyTraits>(*p));
       fm0.template registerEvaluator<EvalT>(ev);
      }
