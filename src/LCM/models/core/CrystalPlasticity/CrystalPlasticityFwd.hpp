...
static constexpr RealType HUGE_ = std::numeric_limits<RealType>::max();

static const RealType LOG_HUGE = std::log(HUGE_);

static constexpr minitensor::Index MAX_DIM = 3;

static constexpr minitensor::Index MAX_SLIP = 48;

static constexpr minitensor::Index MAX_FAMILY = 3;

static constexpr RealType MIN_TOL = 1.0e-14;
...
static constexpr minitensor::Index NLS_DIM = NlsDim<MAX_SLIP>::value;
