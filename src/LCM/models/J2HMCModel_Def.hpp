...
{
  // extract increments
  std::vector< PHX::MDField<const ScalarT>> delta_strainDifference(numMicroScales);
  std::vector< PHX::MDField<const ScalarT>> delta_microStrainGradient(numMicroScales);
