...
/******************************************************************************/
{
  ...
  minitensor::Tensor4<ScalarT> Ctmp(num_dims_); Ctmp.clear();
  minitensor::Tensor3<ScalarT> etmp(num_dims_); etmp.clear();
  minitensor::Tensor<ScalarT> epstmp(num_dims_); epstmp.clear();
  ...
  etmp(0,0,2) = e15/2.0; etmp(0,2,0) = e15/2.0;
  etmp(1,1,2) = e15/2.0; etmp(1,2,1) = e15/2.0;
  etmp(2,0,0) = e31; etmp(2,1,1) = e31; etmp(2,2,2) = e33;
