...
#if !defined(LCM_MultiPhysicsCrystalPlasticityModel_hpp)
#define LCM_MultiPhysicsCrystalPlasticityModel_hpp
...
//! \brief MultiPhysicsCrystalPlasticity Plasticity Constitutive Model
template<typename EvalT, typename Traits>
class MultiPhysicsCrystalPlasticityModel: public LCM::ConstitutiveModel<EvalT, Traits>
{
public:
  ...
  /// Constructor
  ///
  MultiPhysicsCrystalPlasticityModel(Teuchos::ParameterList* p,
  ...
  ///
  virtual
  ~MultiPhysicsCrystalPlasticityModel()
  {};
...
private:
  ...
  ///
  MultiPhysicsCrystalPlasticityModel(const MultiPhysicsCrystalPlasticityModel&);

  ///
  /// Private to prohibit copying
  ///
  MultiPhysicsCrystalPlasticityModel& operator=(const MultiPhysicsCrystalPlasticityModel&);
