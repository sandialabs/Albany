...
LandIce::StokesL1L2::
StokesL1L2( const Teuchos::RCP<Teuchos::ParameterList>& params_,
...
void
LandIce::StokesL1L2::constructDirichletEvaluators(
        const Albany::MeshSpecsStruct& meshSpecs)
{
...
LandIce::StokesL1L2::getValidProblemParameters() const
{
