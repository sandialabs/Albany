...
PHAL_INSTANTIATE_TEMPLATE_CLASS_WITH_TWO_SCALAR_TYPES(LandIce::BinarySumOp)
PHAL_INSTANTIATE_TEMPLATE_CLASS_WITH_TWO_SCALAR_TYPES(LandIce::BinaryProdOp)
...
PHAL_INSTANTIATE_TEMPLATE_FUNCTION(LandIce::buildSimpleEvaluator,
