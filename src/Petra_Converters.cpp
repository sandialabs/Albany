...
Petra::ExtractDiagonalCopy(const Teuchos::RCP<Tpetra_CrsMatrix>& matrix) 
{
...
void
Petra::ReplaceDiagonalEntries(const Teuchos::RCP<Tpetra_CrsMatrix>& matrix,
...
Teuchos::RCP<Tpetra_Vector> 
Petra::InvRowSum(const Teuchos::RCP<const Tpetra_CrsMatrix>& matrix) 
{
