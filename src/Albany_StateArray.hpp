...
//*****************************************************************//
#if !defined(Albany_StateArray_hpp)
#define Albany_StateArray_hpp

#include <string>
#include <vector>

// Macro to compile in array bounds checking:
#if defined(ALBANY_STATEARRAY_BOUNDS_CHECKING)
#define ALBANY_STATEARRAY_CHECK(X) X
#else
#define ALBANY_STATEARRAY_CHECK(X)
#endif
...
struct Compare
{
  ...
  template<typename T>
  inline static bool
  equal(const T* const x, const T* const y)
  {
  ...
  template<typename T>
  inline static bool
  not_equal(const T* const x, const T* const y)
  {
  ...
  template<typename T>
  inline static bool
  less(const T* const x, const T* const y)
  {
  ...
  template<typename T>
  inline static bool
  less_equal(const T* const x, const T* const y)
  {
  ...
  template<typename T>
  inline static bool
  greater(const T* const x, const T* const y)
  {
  ...
  template<typename T>
  inline static bool
  greater_equal(const T* const x, const T* const y)
  {
    return x[I] != y[I] ? x[I] > y[I] :
                          Compare<N - 1, I + 1>::greater_equal(x, y);
  }
...
struct Copy<0, i>
{
  ...
  Copy() {}
  template<typename T>
  inline Copy(T* const, const T* const)
  {
  }
  template<typename T>
  inline Copy(T* const, const T)
  {
  }
};
...
struct Sum<0, i>
{
  ...
  Sum() {}
  template<typename T>
  inline Sum(T* const, const T* const)
  {
  }
  template<typename T>
  inline Sum(T* const, const T, const T* const)
  {
  }
};
...
struct Prod<0, i>
{
  ...
  Prod() {}
  template<typename T>
  inline Prod(T* const, const T* const)
  {
  }
};
...
struct Max<0, i>
{
  ...
  Max() {}
  template<typename T>
  inline Max(T* const, const T* const)
  {
  }
};
...
struct Min<0, i>
{
  ...
  Min() {}
  template<typename T>
  inline Min(T* const, const T* const)
  {
  }
};
...
struct BitOr<0, i>
{
  ...
  BitOr() {}
  template<typename T>
  inline BitOr(T* const, const T* const)
  {
  }
};
...
struct BitAnd<0, i>
{
  ...
  BitAnd() {}
  template<typename T>
  inline BitAnd(T* const, const T* const)
  {
  }
};
...
struct Compare<0, i>
{
  ...
  template<typename T>
  inline static bool
  equal(const T* const, const T* const)
  {
    return true;
  }
  ...
  template<typename T>
  inline static bool
  not_equal(const T* const, const T* const)
  {
    return false;
  }
  ...
  template<typename T>
  inline static bool
  less(const T* const, const T* const)
  {
    return false;
  }
  ...
  template<typename T>
  inline static bool
  less_equal(const T* const, const T* const)
  {
    return true;
  }
  ...
  template<typename T>
  inline static bool
  greater(const T* const, const T* const)
  {
    return false;
  }
  ...
  template<typename T>
  inline static bool
  greater_equal(const T* const, const T* const)
  {
    return true;
  }
};
 ...
 *  <PRE>
 *  struct MyTag : public Albany::ArrayDimTag {
...
class ArrayDimTag {
 public:
   ...
   */
  virtual std::string
  to_string(size_type dimension, size_type index) const;
   ...
   */
  virtual size_type
  to_index(size_type dimension, const std::string& label) const;
...
class ArrayDimension : public ArrayDimTag {
 ...
 private:
  ...
  ArrayDimension&
  operator=(const ArrayDimension&);
};

/** \brief  Macro for declaration of a simple ArrayDimTag
 *  \param ADT  name of the tag.
 */
#define ALBANY_STATEARRAY_DIM_TAG_SIMPLE_DECLARATION(ADT) \
  class ADT : public Albany::ArrayDimTag {                \
   public:                                                \
    const char*                                           \
    name() const;                                         \
    static const ADT&                                     \
 ...
 *  \param ADT  name of the tag.
 */
#define ALBANY_STATEARRAY_DIM_TAG_SIMPLE_IMPLEMENTATION(ADT) \
  ADT::ADT() {}                                              \
  ADT::~ADT() {}                                             \
  const char* ADT::name() const                              \
  {                                                          \
    static const char n[] = #ADT;                            \
    return n;                                                \
  }                                                          \
  const ADT& ADT::tag()                                      \
  {                                                          \
    static const ADT self;                                   \
    return self;                                             \
  }
...
inline iType
stride_size(const iType& rank, const iType* const stride)
{
...
template<typename iType>
inline void
stride_from_natural_dimensions(
    const iType        rank,
    iType* const       stride,
...
void
check_rank(const int_t rank, const int_t test_rank);

void
check_range(const int_t index, const int_t bound);
...
template<int_t Index, int_t Bound>
struct CheckRange;
...
template<ArrayOrder, int_t Rank, int_t Ordinal = 0>
struct StrideDim;
...
struct StrideDim<FortranOrder, Rank, 0>
{
  ...
  template<typename iType>
  static iType
  dimension(const iType* stride, iType ordinal)
  {
...
struct Offset<FortranOrder>
{
  ...
  op(const isType* const stride,
     ...
     const iType&        i8)
  {
    ALBANY_STATEARRAY_CHECK(
        check_indices(false, 8, stride, i1, i2, i3, i4, i5, i6, i7, i8));
  ...
  {
    ALBANY_STATEARRAY_CHECK(
        check_indices(false, 7, stride, i1, i2, i3, i4, i5, i6, i7));
    return i1 + i2 * stride[0] + i3 * stride[1] + i4 * stride[2] +
  ...
  {
    ALBANY_STATEARRAY_CHECK(
        check_indices(false, 6, stride, i1, i2, i3, i4, i5, i6));
    return i1 + i2 * stride[0] + i3 * stride[1] + i4 * stride[2] +
  ...
  {
    ALBANY_STATEARRAY_CHECK(
        check_indices(false, 5, stride, i1, i2, i3, i4, i5));
    return i1 + i2 * stride[0] + i3 * stride[1] + i4 * stride[2] +
           i5 * stride[3];
  }
  ...
  op(const isType* const stride,
     ...
     const iType&        i4)
  {
    ALBANY_STATEARRAY_CHECK(check_indices(false, 4, stride, i1, i2, i3, i4));
    return i1 + i2 * stride[0] + i3 * stride[1] + i4 * stride[2];
  }
  ...
  op(const isType* const stride,
     ...
     const iType&        i3)
  {
    ALBANY_STATEARRAY_CHECK(check_indices(false, 3, stride, i1, i2, i3));
    return i1 + i2 * stride[0] + i3 * stride[1];
  }

  template<typename isType, typename iType>
  static iType
  op(const isType* const stride, const iType& i1, const iType& i2)
  {
    ALBANY_STATEARRAY_CHECK(check_indices(false, 2, stride, i1, i2));
    return i1 + i2 * stride[0];
  }

  template<typename isType, typename iType>
  static iType
  op(const isType* const ALBANY_STATEARRAY_CHECK(stride), const iType& i1)
  {
    ALBANY_STATEARRAY_CHECK(check_indices(false, 1, stride, i1));
    return i1;
  }
};
...
struct Offset<NaturalOrder>
{
  ...
  {
    ALBANY_STATEARRAY_CHECK(
        check_indices(true, 8, stride, i1, i2, i3, i4, i5, i6, i7, i8));
    return i8 + i7 * stride[0] + i6 * stride[1] + i5 * stride[2] +
  ...
  {
    ALBANY_STATEARRAY_CHECK(
        check_indices(true, 7, stride, i1, i2, i3, i4, i5, i6, i7));
    return i7 + i6 * stride[0] + i5 * stride[1] + i4 * stride[2] +
  ...
  {
    ALBANY_STATEARRAY_CHECK(
        check_indices(true, 6, stride, i1, i2, i3, i4, i5, i6));
    return i6 + i5 * stride[0] + i4 * stride[1] + i3 * stride[2] +
  ...
  op(const isType* const stride,
     ...
     const iType&        i5)
  {
    ALBANY_STATEARRAY_CHECK(check_indices(true, 5, stride, i1, i2, i3, i4, i5));
    return i5 + i4 * stride[0] + i3 * stride[1] + i2 * stride[2] +
           i1 * stride[3];
  }
  ...
  op(const isType* const stride,
     ...
     const iType&        i4)
  {
    ALBANY_STATEARRAY_CHECK(check_indices(true, 4, stride, i1, i2, i3, i4));
    return i4 + i3 * stride[0] + i2 * stride[1] + i1 * stride[2];
  }
  ...
  op(const isType* const stride,
     ...
     const iType&        i3)
  {
    ALBANY_STATEARRAY_CHECK(check_indices(true, 3, stride, i1, i2, i3));
  ...
  op(const isType* const stride, const iType& i1, const iType& i2)
  {
    ALBANY_STATEARRAY_CHECK(check_indices(true, 2, stride, i1, i2));
  ...
  op(const isType* const ALBANY_STATEARRAY_CHECK(stride), const iType& i1)
  {
    ALBANY_STATEARRAY_CHECK(check_indices(true, 1, stride, i1));
    return i1;
  }
};
    ...
    Tag8>
{
  ...
  static bool
  verify(const int_t rank, const ArrayDimTag* const tags[])
  {
    return rank == Rank && tags[0] == &Tag8::tag() && tags[1] == &Tag7::tag() &&
           tags[2] == &Tag6::tag() && tags[3] == &Tag5::tag() &&
           tags[4] == &Tag4::tag() && tags[5] == &Tag3::tag() &&
           tags[6] == &Tag2::tag() && tags[7] == &Tag1::tag();
  }

  static void
  assign_tags(const ArrayDimTag* tags[])
  {
    tags[0] = &Tag8::tag();
    tags[1] = &Tag7::tag();
    tags[2] = &Tag6::tag();
  ...
  template<typename iType>
  static void
  assign(iType* stride, const iType& n1)
  {
    stride[7] =
        n1 *
        (stride[6] =
  ...
  template<typename iType>
  static void
  assign(iType* stride, const iType& n1, const iType& n2)
  {
    stride[7] =
        n1 *
        (stride[6] =
  ...
  template<typename iType>
  static void
  assign(iType* stride, const iType& n1, const iType& n2, const iType& n3)
  {
    stride[7] =
        n1 *
        (stride[6] =
             ...
             (stride[5] =
                  ...
                  (stride[4] =
                       ...
                       (stride[3] =
                            n5 *
                            (stride[2] =
                                 n6 * (stride[1] = n7 * (stride[0] = n8)))))));
  }

  template<typename iType>
  static void
  assign(iType* stride, const iType* const dims)
  {
    stride[7] =
        dims[0] *
        (stride[6] =
    ...
    Tag8>
{
  ...
  static bool
  verify(int_t rank, const ArrayDimTag* tags[])
  {
    return rank == Rank && tags[0] == &Tag1::tag() && tags[1] == &Tag2::tag() &&
           tags[2] == &Tag3::tag() && tags[3] == &Tag4::tag() &&
           tags[4] == &Tag5::tag() && tags[5] == &Tag6::tag() &&
           tags[6] == &Tag7::tag() && tags[7] == &Tag8::tag();
  }
  ...
  template<typename iType>
  static void
  assign(iType* stride, const iType& n8)
  {
    stride[7] =
        n8 *
        (stride[6] =
  ...
  template<typename iType>
  static void
  assign(iType* stride, const iType& n7, const iType& n8)
  {
    stride[7] =
        n8 *
        (stride[6] =
  ...
  template<typename iType>
  static void
  assign(iType* stride, const iType& n6, const iType& n7, const iType& n8)
  {
    stride[7] =
        n8 *
        (stride[6] =
    ...
    void>
{
  ...
  verify(int_t rank, const ArrayDimTag* tags[])
  {
    return rank == Rank && tags[0] == &Tag7::tag() && tags[1] == &Tag6::tag() &&
           tags[2] == &Tag5::tag() && tags[3] == &Tag4::tag() &&
           tags[4] == &Tag3::tag() && tags[5] == &Tag2::tag() &&
           tags[6] == &Tag1::tag();
  }
        ...
        (stride[5] =
             ...
             (stride[4] =
                  ...
                  (stride[3] =
                       ...
                       (stride[2] =
                            dims[4] *
                            (stride[1] = dims[5] * (stride[0] = dims[6]))))));
  }
};
    ...
    void>
{
  ...
  template<typename iType>
  static void
  assign(iType* stride, const iType& n7)
  {
    stride[7] = 0;
    stride[6] =
        n7 *
  ...
  template<typename iType>
  static void
  assign(iType* stride, const iType& n6, const iType& n7)
  {
    stride[7] = 0;
    stride[6] =
        n7 *
  ...
  template<typename iType>
  static void
  assign(iType* stride, const iType& n5, const iType& n6, const iType& n7)
  {
    stride[7] = 0;
    stride[6] =
        n7 *
    ...
    void>
{
  ...
  verify(int_t rank, const ArrayDimTag* tags[])
  {
    return rank == Rank && tags[0] == &Tag6::tag() && tags[1] == &Tag5::tag() &&
           tags[2] == &Tag4::tag() && tags[3] == &Tag3::tag() &&
           tags[4] == &Tag2::tag() && tags[5] == &Tag1::tag();
  }
    ...
    stride[5] =
        ...
        (stride[4] =
             ...
             (stride[3] =
                  ...
                  (stride[2] =
                       Tag4::Size *
                       (stride[1] = Tag5::Size * (stride[0] = Tag6::Size)))));
  }
      ...
      const iType& n5)
  {
    ...
    stride[5] =
        ...
        (stride[4] =
             ...
             (stride[3] =
                  n3 * (stride[2] =
                            n4 * (stride[1] = n5 * (stride[0] = Tag6::Size)))));
  }
      ...
      const iType& n6)
  {
    ...
    stride[5] =
        ...
        (stride[4] =
             n2 *
             (stride[3] =
                  n3 * (stride[2] = n4 * (stride[1] = n5 * (stride[0] = n6)))));
  }
    ...
    stride[5] =
        ...
        (stride[4] =
             ...
             (stride[3] =
                  dims[2] *
                  (stride[2] = dims[3] *
                               (stride[1] = dims[4] * (stride[0] = dims[5])))));
  }
};
    ...
    void>
{
  ...
  template<typename iType>
  static void
  assign(iType* stride, const iType& n6)
  {
    stride[7] = 0;
    stride[6] = 0;
    stride[5] =
  ...
  template<typename iType>
  static void
  assign(iType* stride, const iType& n5, const iType& n6)
  {
    stride[7] = 0;
    stride[6] = 0;
    stride[5] =
  ...
  template<typename iType>
  static void
  assign(iType* stride, const iType& n4, const iType& n5, const iType& n6)
  {
    stride[7] = 0;
    stride[6] = 0;
    stride[5] =
      ...
      const iType& n6)
  {
    ...
    stride[5] =
        ...
        (stride[4] =
             ...
             (stride[3] =
                  n4 * (stride[2] =
                            n3 * (stride[1] = n2 * (stride[0] = Tag1::Size)))));
  }
      ...
      const iType& n6)
  {
    ...
    stride[5] =
        ...
        (stride[4] =
             n5 *
             (stride[3] =
                  n4 * (stride[2] = n3 * (stride[1] = n2 * (stride[0] = n1)))));
  }
    ...
    void>
{
  ...
  verify(int_t rank, const ArrayDimTag* tags[])
  {
    return rank == Rank && tags[0] == &Tag5::tag() && tags[1] == &Tag4::tag() &&
           tags[2] == &Tag3::tag() && tags[3] == &Tag2::tag() &&
           tags[4] == &Tag1::tag();
  }
  ...
  assign(iType* stride)
  {
    ...
    stride[4] =
        ...
        (stride[3] =
             Tag2::Size *
             (stride[2] = Tag3::Size *
                          (stride[1] = Tag4::Size * (stride[0] = Tag5::Size))));
  }
  ...
  assign(iType* stride, const iType& n1, const iType& n2)
  {
    ...
    stride[4] =
        n1 *
        (stride[3] = n2 * (stride[2] = Tag3::Size *
                                       (stride[1] = Tag4::Size *
                                                    (stride[0] = Tag5::Size))));
  }
  ...
  assign(iType* stride, const iType& n1, const iType& n2, const iType& n3)
  {
    ...
    stride[4] =
        n1 *
        (stride[3] =
             n2 * (stride[2] = n3 * (stride[1] = Tag4::Size *
                                                 (stride[0] = Tag5::Size))));
  }
      ...
      const iType& n4)
  {
    ...
    stride[4] =
        n1 * (stride[3] =
                  n2 * (stride[2] =
                            n3 * (stride[1] = n4 * (stride[0] = Tag5::Size))));
  }
      ...
      const iType& n5)
  {
    ...
    stride[4] =
        n1 * (stride[3] =
                  n2 * (stride[2] = n3 * (stride[1] = n4 * (stride[0] = n5))));
  }
  ...
  assign(iType* stride, const iType* const dims)
  {
    ...
    stride[4] =
        ...
        (stride[3] =
             dims[1] *
             (stride[2] =
                  dims[2] * (stride[1] = dims[3] * (stride[0] = dims[4]))));
  }
};
    ...
    void>
{
  ...
  template<typename iType>
  static void
  assign(iType* stride, const iType& n5)
  {
    stride[7] = 0;
    stride[6] = 0;
    stride[5] = 0;
  ...
  template<typename iType>
  static void
  assign(iType* stride, const iType& n4, const iType& n5)
  {
    stride[7] = 0;
    stride[6] = 0;
    stride[5] = 0;
    stride[4] =
        n5 *
        (stride[3] = n4 * (stride[2] = Tag3::Size *
                                       (stride[1] = Tag2::Size *
                                                    (stride[0] = Tag1::Size))));
  }
  ...
  template<typename iType>
  static void
  assign(iType* stride, const iType& n3, const iType& n4, const iType& n5)
  {
    stride[7] = 0;
    stride[6] = 0;
    stride[5] = 0;
    stride[4] =
        n5 *
        (stride[3] =
             n4 * (stride[2] = n3 * (stride[1] = Tag2::Size *
                                                 (stride[0] = Tag1::Size))));
  }
  ...
  assign(iType* stride, const iType* const dims)
  {
    ...
    stride[4] =
        ...
        (stride[3] =
             dims[3] *
             (stride[2] =
                  dims[2] * (stride[1] = dims[1] * (stride[0] = dims[0]))));
  }
};
    ...
    void>
{
  ...
  verify(int_t rank, const ArrayDimTag* tags[])
  {
    return rank == Rank && tags[0] == &Tag4::tag() && tags[1] == &Tag3::tag() &&
           tags[2] == &Tag2::tag() && tags[3] == &Tag1::tag();
  }
  ...
  assign(iType* stride)
  {
    ...
    stride[3] =
        Tag1::Size *
        (stride[2] =
             Tag2::Size * (stride[1] = Tag3::Size * (stride[0] = Tag4::Size)));
  }
  ...
  assign(iType* stride, const iType& n1)
  {
    ...
    stride[4] = 0;
    stride[3] =
        n1 * (stride[2] = Tag2::Size *
                          (stride[1] = Tag3::Size * (stride[0] = Tag4::Size)));
  }
  ...
  assign(iType* stride, const iType& n1, const iType& n2)
  {
    ...
    stride[3] =
        n1 *
        (stride[2] = n2 * (stride[1] = Tag3::Size * (stride[0] = Tag4::Size)));
  }
  ...
  assign(iType* stride, const iType& n1, const iType& n2, const iType& n3)
  {
    ...
    stride[4] = 0;
    stride[3] =
        n1 * (stride[2] = n2 * (stride[1] = n3 * (stride[0] = Tag4::Size)));
  }
  ...
  assign(iType* stride, const iType* const dims)
  {
    ...
    stride[3] =
        dims[0] *
        (stride[2] = dims[1] * (stride[1] = dims[2] * (stride[0] = dims[3])));
  }
};
    ...
    void>
{
  ...
  assign(iType* stride)
  {
    ...
    stride[3] =
        Tag4::Size *
        (stride[2] =
             Tag3::Size * (stride[1] = Tag2::Size * (stride[0] = Tag1::Size)));
  }

  template<typename iType>
  static void
  assign(iType* stride, const iType& n4)
  {
    stride[7] = 0;
    stride[6] = 0;
    stride[5] = 0;
    stride[4] = 0;
    stride[3] =
        n4 * (stride[2] = Tag3::Size *
                          (stride[1] = Tag2::Size * (stride[0] = Tag1::Size)));
  }

  template<typename iType>
  static void
  assign(iType* stride, const iType& n3, const iType& n4)
  {
    stride[7] = 0;
    stride[6] = 0;
    stride[5] = 0;
    ...
    stride[3] =
        n4 *
        (stride[2] = n3 * (stride[1] = Tag2::Size * (stride[0] = Tag1::Size)));
  }

  template<typename iType>
  static void
  assign(iType* stride, const iType& n2, const iType& n3, const iType& n4)
  {
    stride[7] = 0;
    stride[6] = 0;
    stride[5] = 0;
    stride[4] = 0;
    stride[3] =
        n4 * (stride[2] = n3 * (stride[1] = n2 * (stride[0] = Tag1::Size)));
  }
  ...
  assign(iType* stride, const iType* const dims)
  {
    ...
    stride[3] =
        dims[3] *
        (stride[2] = dims[2] * (stride[1] = dims[1] * (stride[0] = dims[0])));
  }
};
    ...
    void>
{
  ...
  verify(int_t rank, const ArrayDimTag* tags[])
  {
    return rank == Rank && tags[0] == &Tag3::tag() && tags[1] == &Tag2::tag() &&
           tags[2] == &Tag1::tag();
  }
  ...
  assign(iType* stride)
  {
    ...
    stride[3] = 0;
    stride[2] =
        Tag1::Size * (stride[1] = Tag2::Size * (stride[0] = Tag3::Size));
  }
  ...
  assign(iType* stride, const iType& n1)
  {
    ...
    stride[4] = 0;
    stride[3] = 0;
    stride[2] = n1 * (stride[1] = Tag2::Size * (stride[0] = Tag3::Size));
  }
  ...
  assign(iType* stride, const iType& n1, const iType& n2)
  {
    ...
    stride[4] = 0;
    stride[3] = 0;
    stride[2] = n1 * (stride[1] = n2 * (stride[0] = Tag3::Size));
  }
  ...
  assign(iType* stride, const iType* const dims)
  {
    ...
    stride[4] = 0;
    stride[3] = 0;
    stride[2] = dims[0] * (stride[1] = dims[1] * (stride[0] = dims[2]));
  }
};
    ...
    void>
{
  ...
  template<typename iType>
  static void
  assign(iType* stride, const iType& n3)
  {
    stride[7] = 0;
    stride[6] = 0;
    stride[5] = 0;
  ...
  template<typename iType>
  static void
  assign(iType* stride, const iType& n2, const iType& n3)
  {
    stride[7] = 0;
    stride[6] = 0;
    stride[5] = 0;
    stride[4] = 0;
    stride[3] = 0;
    stride[2] = n3 * (stride[1] = n2 * (stride[0] = Tag1::Size));
  }
    ...
    void>
{
  ...
  verify(int_t rank, const ArrayDimTag* tags[])
  {
    return rank == Rank && tags[0] == &Tag2::tag() && tags[1] == &Tag1::tag();
  }
  ...
  assign(iType* stride, const iType* const dims)
  {
    ...
    stride[3] = 0;
    stride[2] = 0;
    stride[1] = dims[0] * (stride[0] = dims[1]);
  }
};
    ...
    void>
{
  ...
  template<typename iType>
  static void
  assign(iType* stride, const iType& n2)
  {
    stride[7] = 0;
    stride[6] = 0;
    stride[5] = 0;
...
template<class ArrayType, class TagA>
struct ArrayAppend
{
};
...
template<
    ...
    class TagA>
struct ArrayAppend<
    Array<Scalar, Order, Tag1, Tag2, Tag3, Tag4, Tag5, Tag6, Tag7, void>,
    TagA>
{
 private:
  typedef typename array_traits::
      Helper<Scalar, Order, Tag1, Tag2, Tag3, Tag4, Tag5, Tag6, Tag7, void>::
          template append<TagA>
              helper;
...
class Array<
 ...
 public:
  ...
  enum
  {
    Natural = NaturalOrder == array_order
  };

  /** \brief  If the multidimension follows the reverse (Fortran) ordering */
  enum
  {
    Reverse = FortranOrder == array_order
  };
  ...
  {
    ALBANY_STATEARRAY_CHECK(array_traits::check_range(i, size()));
    return m_ptr[i];
  }
  ...
  {
    ALBANY_STATEARRAY_CHECK(array_traits::check_rank(m_rank, 8));
  ...
  {
    ALBANY_STATEARRAY_CHECK(array_traits::check_rank(m_rank, 7));
  ...
  {
    ALBANY_STATEARRAY_CHECK(array_traits::check_rank(m_rank, 6));
  ...
  {
    ALBANY_STATEARRAY_CHECK(array_traits::check_rank(m_rank, 5));
    return m_ptr[Offset::op(m_stride, i1, i2, i3, i4, i5)];
  }

  template<typename iType>
  value_type&
  operator()(const iType& i1, const iType& i2, const iType& i3, const iType& i4)
      const
  {
    ALBANY_STATEARRAY_CHECK(array_traits::check_rank(m_rank, 4));
    return m_ptr[Offset::op(m_stride, i1, i2, i3, i4)];
  }

  template<typename iType>
  value_type&
  operator()(const iType& i1, const iType& i2, const iType& i3) const
  {
    ALBANY_STATEARRAY_CHECK(array_traits::check_rank(m_rank, 3));
    return m_ptr[Offset::op(m_stride, i1, i2, i3)];
  }

  template<typename iType>
  value_type&
  operator()(const iType& i1, const iType& i2) const
  {
    ALBANY_STATEARRAY_CHECK(array_traits::check_rank(m_rank, 2));
    return m_ptr[Offset::op(m_stride, i1, i2)];
  }

  template<typename iType>
  value_type&
  operator()(const iType& i1) const
  {
    ALBANY_STATEARRAY_CHECK(array_traits::check_rank(m_rank, 1));
  ...
  typedef typename array_traits::Helper<
      Scalar,
      array_order,
      void,
      void,
      ...
      void,
      void,
      void>::reverse ReverseType;

  Array() : m_ptr(NULL), m_rank(0)
  {
    Copy<8>(m_stride, (size_type)0);
    Copy<8>(m_tag, (tag_type)NULL);
  }

  Array(const Array& rhs) : m_ptr(rhs.m_ptr), m_rank(rhs.m_rank)
  {
  ...
  Array(const ReverseType& rhs) : m_ptr(rhs.m_ptr), m_rank(rhs.m_rank)
  {
    Copy<8>(m_stride, rhs.m_stride);
    Copy<8>(m_tag, rhs.m_tag);
  }
  ...
  Array&
  operator=(const ReverseType& rhs)
  {
    m_ptr  = rhs.m_ptr;
    m_rank = rhs.m_rank;
    Copy<8>(m_stride, rhs.m_stride);
      ...
      size_type   n7)
  {
    ...
    m_rank = helper::Rank;
    helper::assign_tags(m_tag);
    helper::assign(m_stride, n1, n2, n3, n4, n5, n6, n7);
    return *this;
  }
  ...
  Array&
  assign(value_type* ptr, size_type n1, size_type n2, size_type n3)
  {
    typedef array_traits::Helper<
        Scalar,
        array_order,
  ...
  Array&
  assign(value_type* ptr, size_type n1, size_type n2)
  {
    typedef array_traits::Helper<
        Scalar,
        array_order,
  ...
  template<class Tag1>
  Array&
  assign(value_type* ptr, size_type n1)
  {
    typedef array_traits::Helper<
        Scalar,
        array_order,
 ...
 private:
  ...
  Array(const Array& rhs, const size_type i) : m_ptr(NULL), m_rank(0)
  {
    if (1 < rhs.m_rank) {
      Copy<8>(m_stride, rhs.m_stride);
      Copy<8>(m_tag, rhs.m_tag);
...
class Array {
 ...
 public:
  ...
  /** \brief  Access the dimension tag-singleton for a given ordinate. */
  tag_type
  tag(const size_type ordinate) const
  {
  ...
  /** \brief  Dimension of the given ordinate. */
  size_type
  dimension(const size_type ordinate) const
  {
  ...
  size() const
  {
    return m_array.m_stride[Rank - 1];
  }
  ...
  contiguous_data() const
  {
    return m_array.contiguous_data();
  }
  ...
  Array&
  assign(value_type* arg_ptr, const size_type* const dims)
  {
  ...
  Array(value_type* arg_ptr, const size_type* const dims) : m_array()
  {
    m_array.m_rank = Rank;
    helper::assign_tags(m_array.m_tag);
    assign(arg_ptr, dims);
   ...
   */
  Array&
  assign(value_type* arg_ptr, const size_type n1, const size_type n2)
  {
   ...
   *          The input dimensions are the 2 slowest strides.
   */
  Array(value_type* arg_ptr, const size_type n1, const size_type n2) : m_array()
  {
    m_array.m_rank = Rank;
    helper::assign_tags(m_array.m_tag);
   ...
   */
  Array&
  assign(value_type* arg_ptr, const size_type n1)
  {
    array_traits::CheckRange<0, Rank>::ok();
    m_array.m_ptr = arg_ptr;
   ...
   *          The input dimension is the slowest stride.
   */
  Array(value_type* arg_ptr, const size_type n1) : m_array()
  {
    m_array.m_rank = Rank;
    helper::assign_tags(m_array.m_tag);
    assign(arg_ptr, n1);
  ...
  /** \brief  Construct a Rank 1..8 array; use Tag#::Size for defaults. */
  Array(value_type* arg_ptr) : m_array()
  {
    m_array.m_rank = Rank;
    helper::assign_tags(m_array.m_tag);
    assign(arg_ptr);
  ...
  Array(const Array<Scalar, array_order>& rhs) : m_array(rhs)
  {
    if (!helper::verify(m_array.m_rank, m_array.m_tag)) {
      m_array.m_rank = Rank;
      helper::assign_tags(m_array.m_tag);
      array_traits::throw_bad_conversion(
          m_array.m_rank, m_array.m_tag, rhs.m_rank, rhs.m_tag);
    }
  }
  ...
  void
  assign_stride(value_type* arg_ptr, const size_type* arg_stride)
  {
    m_array.m_ptr = arg_ptr;
 ...
 protected:
  Array(const Array<Scalar, array_order>& rhs, size_type i) : m_array(rhs, i)
  {
    if (!helper::verify(m_array.m_rank, m_array.m_tag)) {
      m_array.m_rank = Rank;
      helper::assign_tags(m_array.m_tag);
      array_traits::throw_bad_conversion(
          m_array.m_rank, m_array.m_tag, rhs.m_rank - 1, rhs.m_tag);
    }
  }
...
#undef ALBANY_STATEARRAY_CHECK

#endif  // Albany_StateArray_hpp
