...
\trilinos{} on a machine with: Fedora Linux 27; Ubuntu Linux 14.04 LTS, 16.04
LTS, and 18.04 LTS; Scientific Linux 7.5; the Linux CEE/SEMS environment; and
Sandia's HPC systems.
...
on Fedora and the {\tt yum install} command on Scientific Linux
\begin{verbatim}
blas
blas-devel
boost
