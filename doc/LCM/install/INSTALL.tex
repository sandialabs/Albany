...
herein were tested using Fedora 21.
...
the GCC and Intel toolchains, and \verb+cuda+ that is only supported
for the GCC toolchain. The installation and configuration of the Cuda
