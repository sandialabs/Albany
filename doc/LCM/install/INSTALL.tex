...
\title{Installing and compiling \albany{}/\lcm{} and
  \trilinos{} on Fedora, SEMS/CEE, or HPC Sandia clusters}
...
\trilinos{} on a machine with Fedora Linux, the Linux CEE/SEMS environment, or
Sandia's HPC systems. If you want a shortcut, obtain the script
