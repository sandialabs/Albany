...
Go to the the top-level \verb+LCM+ directory and create a symbolic
link to the \verb+DTK+ CMake fragment that resides in
\verb+LCM/Albany/doc/LCM/build+, then clone the \verb+DTK+ repository
and create a symbolic link to this repository inside the
\trilinos{} directory:
\begin{verbatim}
cd ~/LCM
