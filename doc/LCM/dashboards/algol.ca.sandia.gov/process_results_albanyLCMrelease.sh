...
grep " tests failed" nightly_log_albany_LCM_release.txt >& results2 
cat results1 results2 >& results3
grep "Total Test" nightly_log_albany_LCM_release.txt >& results4
cat results3 results4 >& results5
grep "(Failed)" nightly_log_albany_LCM_release.txt >& results6 
