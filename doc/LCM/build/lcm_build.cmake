...
function(capitalize IN OUT)
  ...
  string(REGEX REPLACE "^.(.*)" "${FIRST_LETTER}\\1" TMP_OUT "${IN}")
...
capitalize(${PACKAGE} CAPITAL_PACKAGE)
set(CTEST_BINARY_DIRECTORY "$ENV{LCM_DIR}/${CAPITAL_PACKAGE}-build-${BUILD_STRING}")
message("CTEST_BINARY_DIRECTORY ${CTEST_BINARY_DIRECTORY}")
snl_mkdir("${CTEST_BINARY_DIRECTORY}")

set(CDASH_SUBPROJECT "${CAPITAL_PACKAGE}_$ENV{LCM_ENV_TYPE}_${LCM_HOSTNAME}_${BUILD_STRING}")
