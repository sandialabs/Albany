...
set(BUILD_STRING "$ENV{ARCH}-$ENV{TOOL_CHAIN}-$ENV{BUILD_TYPE}")
...
if (BUILD_TYPE MATCHES "profile")
  set(PACKAGE_BUILD_TYPE "RELWITHDEBINFO")
endif()
if (BUILD_TYPE MATCHES "small")
  set(PACKAGE_BUILD_TYPE "MINSIZEREL")
endif()
if (BUILD_TYPE MATCHES "mixed")
  set(PACKAGE_BUILD_TYPE "RELEASE")
endif()
...
set(PASS_ARGS ${PASS_ARGS} "BUILD_STRING" "${BUILD_STRING}")
...
set(CTEST_BINARY_DIRECTORY "$ENV{LCM_DIR}/${PACKAGE}-build-${BUILD_STRING}")
message("CTEST_BINARY_DIRECTORY ${CTEST_BINARY_DIRECTORY}")
snl_mkdir("${CTEST_BINARY_DIRECTORY}")

set(CDASH_SUBPROJECT "${PACKAGE}_$ENV{LCM_ENV_TYPE}_${LCM_HOSTNAME}_${BUILD_STRING}")
set(PASS_ARGS ${PASS_ARGS} "CDASH_SUBPROJECT" "${CDASH_SUBPROJECT}")
