...
option \texttt{-D ENABLE\_LCM:=ON} needed to enable this code base.
...
code for the Ice Sheet dynamics application described in the introduction. It contains
 \texttt{problems} and \texttt{evaluators} directories that describe and implement
the physics sets needed for this application domain.
...
information from Albany runs and produce reduced order models. 
