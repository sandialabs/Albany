...
# Execute scripts for building trilinos, dakota, and albany
#-------------------------------------------
echo; echo "...Starting Albany Build (64 bit)"
time source $SCRIPTDIR/albany_build_tpetra_64bit.sh

#-------------------------------------------
# Execute albany tests
#-------------------------------------------
echo; echo "...Starting Albany Tests (64 bit)"
time source $SCRIPTDIR/albany_runtest_tpetra_64bit.sh
