...
if [ "$BUILD_OPT" = "intel" ]; then
   . /sierra/sntools/SDK/compilers/intel/composer_xe_2017.1.132/compilers_and_libraries/linux/bin/compilervars.sh intel64
...
export LD_LIBRARY_PATH=/sierra/sntools/SDK/compilers/intel/composer_xe_2017.1.132/compilers_and_libraries/linux/mkl/lib/intel64:/sierra/sntools/SDK/compilers/clang/3.7-RHEL6/lib:/sierra/sntools/SDK/hwloc/lib:/sierra/sntools/SDK/mpi/openmpi/1.8.8-gcc-5.2.0-RHEL6/lib:/sierra/sntools/SDK/compilers/gcc/5.2.0-RHEL6/lib64:/sierra/sntools/SDK/compilers/gcc/5.2.0-RHEL6/lib:/projects/albany/lib
fi
