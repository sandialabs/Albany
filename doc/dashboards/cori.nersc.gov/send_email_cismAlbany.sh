...
TTT=`grep "(Failed)" nightly_log_coriCismAlbany.txt -c`
TTTT=`grep "(Not Run)" nightly_log_coriCismAlbany.txt -c`
TTTTT=`grep "(Timeout)" nightly_log_coriCismAlbany.txt -c`
TT=`grep "...   Passed" nightly_log_coriCismAlbany.txt -c`
