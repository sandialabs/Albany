...
#
# 00 05 * * * /ascldap/users/gahanse/Codes/Albany/doc/dashboards/compton.sandia.gov/cee-compute012/submit_script.sh
...
BASE_DIR=/projects/AppComp/nightly_gahanse/compton-AlbanyMIC
SCRIPT_DIR=/ascldap/users/gahanse/Codes/Albany/doc/dashboards/compton.sandia.gov/cee-compute012
...
LOG_FILE=/projects/AppComp/nightly_gahanse/compton-AlbanyMIC/nightly_log.txt

cd $BASE_DIR

DOWNLOAD_DIR=$BASE_DIR/Download/AlbanyMIC
...
# rsync the files
  echo "rsync -a gahanse@software-login.sandia.gov:/home/gahanse/Albany_compton/ $DOWNLOAD_DIR" >> $LOG_FILE
  echo >> $LOG_FILE
  rsync -a --delete gahanse@software-login.sandia.gov:/home/gahanse/Albany_compton/ $DOWNLOAD_DIR >> $LOG_FILE 2>&1
