...
LOG_FILE=/mnt/encrypted_sdc1/nightlyCDash/nightly_logFPE_config.txt

eval "env  TEST_DIRECTORY=/mnt/encrypted_sdc1/nightlyCDash SCRIPT_DIRECTORY=/mnt/encrypted_sdc1/nightlyCDash ctest -VV -S /mnt/encrypted_sdc1/nightlyCDash/ctest_nightly_albanyFPE_config.cmake" > $LOG_FILE 2>&1
