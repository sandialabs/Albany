...
/bin/mail -s "cism-piscees (felix_interface): $TT tests passed, $TTT tests failed, $TTTT tests not run, $TTTTT timeouts" "ikalash@sandia.gov" < /home/ikalash/nightlyCDash/results_cismAlbany
