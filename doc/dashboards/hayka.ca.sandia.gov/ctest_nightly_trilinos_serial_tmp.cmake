...
if (BUILD_TRILINOS_RELEASE) 
  ...
  #
  set(INSTALL_LOCATION ${CTEST_BINARY_DIRECTORY}/TrilinosReleaseInstall)
  set (CONFIGURE_OPTIONS
      CDASH-TRILINOS-RELEASE-FILE.TXT
  )

  if (NOT EXISTS "${CTEST_BINARY_DIRECTORY}/TriBuildRelease")
    file (MAKE_DIRECTORY ${CTEST_BINARY_DIRECTORY}/TriBuildRelease)
  endif ()

  CTEST_CONFIGURE(
    BUILD "${CTEST_BINARY_DIRECTORY}/TriBuildRelease"
