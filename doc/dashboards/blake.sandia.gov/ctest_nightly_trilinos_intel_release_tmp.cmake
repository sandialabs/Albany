...
if (BUILD_TRILINOS_RELEASE) 
  ...
  #
  set(INSTALL_DIR ${CTEST_BINARY_DIRECTORY}/TrilinosReleaseInstallIntel)
  set (CONFIGURE_OPTIONS
      CDASH-TRILINOS-INTEL-RELEASE-FILE.TXT
  )

  if (NOT EXISTS "${CTEST_BINARY_DIRECTORY}/TriBuildReleaseIntel")
    file (MAKE_DIRECTORY ${CTEST_BINARY_DIRECTORY}/TriBuildReleaseIntel)
  endif ()

  CTEST_CONFIGURE(
    BUILD "${CTEST_BINARY_DIRECTORY}/TriBuildReleaseIntel"
