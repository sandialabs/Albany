...
if (BUILD_TRILINOS_SERIAL) 
  message ("ctest state: BUILD_MINIEM")
  #
  # Configure the Trilinos MiniEM build
  #
  ...
  set (CONFIGURE_OPTIONS
      ...
      #
      "-DNetcdf_LIBRARY_DIRS:STRING=${NETCDF_PATH}/lib"
      "-DNetcdf_INCLUDE_DIRS:STRING=${NETCDF_PATH}/include"
      "-DPnetcdf_LIBRARY_DIRS:STRING=${PNETCDF_PATH}/lib"
      "-DPnetcdf_INCLUDE_DIRS:STRING=${PNETCDF_PATH}/include"
      #
      "-D Trilinos_ENABLE_SEACASNemesis:STRING=OFF"
      #
      "-DTPL_ENABLE_HDF5=ON"
      "-D HDF5_LIBRARY_DIRS:STRING=${HDF5_PATH}/lib"
      "-DHDF5_INCLUDE_DIRS:STRING=${HDF5_PATH}/include"
      #
      "-DTPL_ENABLE_BoostLib=ON"
      "-DBoostLib_LIBRARY_DIRS:PATH=${BOOST_PATH}/lib"
      "-DBoostLib_INCLUDE_DIRS:PATH=${BOOST_PATH}/include"
      #
      "-DBLAS_LIBRARY_DIRS:PATH='/home/projects/x86-64/intel/compilers/2018/compilers_and_libraries_2018.1.163/linux/mkl/lib/intel64/'"
      "-DBLAS_LIBRARY_NAMES:PATH=' mkl_intel_lp64; mkl_intel_thread; mkl_core; iomp5; pthread'"
      "-DLAPACK_LIBRARY_DIRS:PATH='/home/projects/x86-64/intel/compilers/2018/compilers_and_libraries_2018.1.163/linux/mkl/lib/intel64/'"
  ...
  if (NOT EXISTS "${CTEST_BINARY_DIRECTORY}/MiniEMBuild")
    file (MAKE_DIRECTORY ${CTEST_BINARY_DIRECTORY}/MiniEMBuild)
  endif ()

  CTEST_CONFIGURE(
    BUILD "${CTEST_BINARY_DIRECTORY}/MiniEMBuild"
