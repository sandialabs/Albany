...
mv d results_openmp
rm a b c
cat nightly_log_blakeAlbanyOpenMP.txt | /usr/lib/sendmail -F ikalash@blake.sandia.gov -t "ikalash@sandia.gov, daibane@sandia.gov, tjfulle@sandia.gov, amota@sandia.gov, jwatkin@sandia.gov"
