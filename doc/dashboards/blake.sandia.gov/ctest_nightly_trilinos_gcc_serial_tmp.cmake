...
set (CTEST_BUILD_NAME "Trilinos-${osname}-${osrel}-${COMPILER}-${COMPILER_VERSION}-${CTEST_CONFIGURATION}-Serial-No-Warn")
...
if (BUILD_TRILINOS_SERIAL) 
  ...
  #
  set(INSTALL_DIR ${CTEST_BINARY_DIRECTORY}/TrilinosSerialInstallGccNoWarn)
  set (CONFIGURE_OPTIONS
      CDASH-TRILINOS-GCC-SERIAL-FILE.TXT
  )

  if (NOT EXISTS "${CTEST_BINARY_DIRECTORY}/TriBuildSerialGccNoWarn")
    file (MAKE_DIRECTORY ${CTEST_BINARY_DIRECTORY}/TriBuildSerialGccNoWarn)
  endif ()

  CTEST_CONFIGURE(
    BUILD "${CTEST_BINARY_DIRECTORY}/TriBuildSerialGccNoWarn"
