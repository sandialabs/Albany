...
#set (CTEST_BUILD_NAME "blake-debug-Trilinos-gcc-no-warn")
...
set (CTEST_BUILD_NAME "Trilinos-${osname}-${osrel}-${COMPILER}-${COMPILER_VERSION}-Debug-No-Warn")
...
set (BLAS_PATH $ENV{NETLIB_LAPACK_ROOT})
...
set (METIS_PATH $ENV{METIS_ROOT})
set (PARMETIS_PATH $ENV{PARMETIS_ROOT})
 
#MESSAGE("\nMPI_PATH: '${MPI_PATH}'")
#MESSAGE("\nBLAS_PATH: '${BLAS_PATH}'")
#MESSAGE("\nSUPERLU_PATH: '${SUPERLU_PATH}'")
...
# 
if (BUILD_TRILINOS_DEBUG) 
  message ("ctest state: BUILD_TRILINOS_DEBUG")
  #
  # Configure the Trilinos build
  #
  set(INSTALL_DIR ${CTEST_BINARY_DIRECTORY}/TrilinosDebugInstallGccNoWarn)
  set (CONFIGURE_OPTIONS
      CDASH-TRILINOS-GCC-DEBUG-FILE.TXT
  )

  if (NOT EXISTS "${CTEST_BINARY_DIRECTORY}/TriBuildDebugGccNoWarn")
    file (MAKE_DIRECTORY ${CTEST_BINARY_DIRECTORY}/TriBuildDebugGccNoWarn)
  endif ()

  CTEST_CONFIGURE(
    BUILD "${CTEST_BINARY_DIRECTORY}/TriBuildDebugGccNoWarn"
