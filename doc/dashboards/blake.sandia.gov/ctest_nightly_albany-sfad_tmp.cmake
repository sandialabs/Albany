...
if (1)
  ...
  IF(CTEST_BUILD_OPTION MATCHES "sfad6")
    ...
    set (BUILD_ALBANY_GCC_SFAD16 FALSE) 
  ...
  IF(CTEST_BUILD_OPTION MATCHES "sfad12")
    ...
    set (SFAD_SIZE 12)  
  ENDIF()
  IF(CTEST_BUILD_OPTION MATCHES "sfad16")
    set (BUILD_ALBANY_GCC_SFAD6 FALSE) 
    set (BUILD_ALBANY_GCC_SFAD12 FALSE) 
    set (BUILD_ALBANY_GCC_SFAD16 TRUE) 
    set (BUILD_ALBANY_GCC_SFAD24 FALSE) 
    set (SFAD_SIZE 16)  
  ENDIF()
...
ENDIF()
IF (BUILD_ALBANY_GCC_SFAD16) 
  if (NOT EXISTS "${CTEST_BINARY_DIRECTORY}/AlbBuildGccSFad16")
    file (MAKE_DIRECTORY ${CTEST_BINARY_DIRECTORY}/AlbBuildGccSFad16)
  endif ()
  CTEST_CONFIGURE(
    BUILD "${CTEST_BINARY_DIRECTORY}/AlbBuildGccSFad16"
    SOURCE "${CTEST_SOURCE_DIRECTORY}/Albany"
    OPTIONS "${CONFIGURE_OPTIONS}"
    RETURN_VALUE HAD_ERROR
    )
