...
ELSEIF(CTEST_BUILD_OPTION MATCHES "sfad16")
  set (SFAD_SIZE 16)
ELSEIF(CTEST_BUILD_OPTION MATCHES "sfad24")
  set (SFAD_SIZE 24)
ENDIF()
set (ALBANY_INSTALL "/home/projects/albany/nightlyCDashAlbanyBlake/build-gcc/AlbanyReleaseInstallGccSFad${SFAD_SIZE}")
...
IF (SFAD_SIZE)
  if (NOT EXISTS "${CTEST_BINARY_DIRECTORY}/AlbBuildGccSFad${SFAD_SIZE}")
    file (MAKE_DIRECTORY ${CTEST_BINARY_DIRECTORY}/AlbBuildGccSFad${SFAD_SIZE})
  endif ()
  CTEST_CONFIGURE(
    BUILD "${CTEST_BINARY_DIRECTORY}/AlbBuildGccSFad${SFAD_SIZE}"
