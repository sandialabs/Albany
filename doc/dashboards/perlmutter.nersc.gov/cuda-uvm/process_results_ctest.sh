...
echo "" >> results
echo "The Jupyter notebooks containing Perlmutter-cuda-uvm ALI performance data can be accessed here: https://sandialabs.github.io/ali-perf-data/ali/index_perlmutter_cuda_uvm.html" >> results
echo "" >> results
