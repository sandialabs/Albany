...
if (${FAD_CONFIGURATION} MATCHES "sfad" AND ${FAD_SIZE} MATCHES "12")
  set (CTEST_BUILD_NAME "Albany-${osname}-${osrel}-${COMPILER}-${COMPILER_VERSION}-${CTEST_CONFIGURATION}-cuda-uvm-sfad12")
endif()
if (${FAD_CONFIGURATION} MATCHES "sfad" AND ${FAD_SIZE} MATCHES "24")
  set (CTEST_BUILD_NAME "Albany-${osname}-${osrel}-${COMPILER}-${COMPILER_VERSION}-${CTEST_CONFIGURATION}-cuda-uvm-sfad24")
endif()
...
if (BUILD_ALBANY)
  ...
  if (${FAD_CONFIGURATION} MATCHES "slfad")
    set (ALBANY_BUILD_DIR "${CTEST_BINARY_DIRECTORY}/AlbBuildCudaUvmGcc")
  endif()
  if (${FAD_CONFIGURATION} MATCHES "sfad" AND ${FAD_SIZE} MATCHES "12")
    set (ALBANY_BUILD_DIR "${CTEST_BINARY_DIRECTORY}/AlbBuildCudaUvmGccSfad12")
  endif()
  if (${FAD_CONFIGURATION} MATCHES "sfad" AND ${FAD_SIZE} MATCHES "24")
    set (ALBANY_BUILD_DIR "${CTEST_BINARY_DIRECTORY}/AlbBuildCudaUvmGccSfad24")
  endif()
