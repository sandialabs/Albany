...
eval "env BASE_DIR=${BASE_DIR}; env FAD_CONFIGURATION=${FAD_CONFIGURATION}; env FAD_SIZE=${FAD_SIZE}; env TEST_DIRECTORY=$BASE_DIR SCRIPT_DIRECTORY=$BASE_DIR ctest -VV -S ${CMAKE_FILENAME}" > $LOG_FILE 2>&1
