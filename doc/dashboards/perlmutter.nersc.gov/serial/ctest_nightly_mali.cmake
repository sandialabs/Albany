...
set (CTEST_BUILD_NAME "MALI-gcc-serial")
...
if (BUILD_MALI)
  ...
  # HACK: reuse Albany configure output.
  #
  ...
  set (CONFIGURE_OPTIONS
     ...
     "-DCMAKE_INSTALL_PREFIX:PATH=${ALBANY_INSTALL}"
     ...
     "-DCMAKE_INSTALL_RPATH:PATH=${ALBANY_INSTALL}/lib64"
     "-DCMAKE_INSTALL_RPATH_USE_LINK_PATH:BOOL=ON"
     "-DENABLE_FAD_TYPE:STRING='SFad'"
     "-DALBANY_SFAD_SIZE=12"
     "-DENABLE_TAN_FAD_TYPE:STRING='SLFad'"
     "-DALBANY_TAN_SLFAD_SIZE=6"
     "-DENABLE_HES_VEC_FAD_TYPE:STRING='SFad'"
     "-DALBANY_HES_VEC_SFAD_SIZE=12"
     "-DENABLE_MPAS_INTERFACE:BOOL=ON"
     "-DENABLE_OMEGAH:BOOL=OFF"
    )
  CTEST_CONFIGURE(
    BUILD "${CTEST_BINARY_DIRECTORY}/AlbBuildSerialGccSfad12"
