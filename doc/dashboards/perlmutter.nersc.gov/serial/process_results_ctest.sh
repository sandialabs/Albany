...
echo "" >> results
echo "The Jupyter notebooks containing Perlmutter-serial ALI performance data can be accessed here: https://sandialabs.github.io/ali-perf-data/ali/index_perlmutter_serial.html" >> results
echo "" >> results
