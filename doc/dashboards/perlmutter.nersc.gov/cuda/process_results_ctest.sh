...
echo "" >> results
echo "The Jupyter notebooks containing Perlmutter-cuda ALI performance data can be accessed here: https://sandialabs.github.io/ali-perf-data/ali/index_perlmutter_cuda.html" >> results
echo "" >> results
