...
ELSEIF(CTEST_BUILD_OPTION MATCHES "sfad24")
  set (SFAD_SIZE 24)
ENDIF()
set (ALBANY_INSTALL "${CTEST_BINARY_DIRECTORY}/AlbanyInstallSFad${SFAD_SIZE}")
...
if (SFAD_SIZE)
  if (NOT EXISTS "${CTEST_BINARY_DIRECTORY}/AlbBuildSFad${SFAD_SIZE}")
    file (MAKE_DIRECTORY ${CTEST_BINARY_DIRECTORY}/AlbBuildSFad${SFAD_SIZE})
  endif ()
  CTEST_CONFIGURE(
    BUILD "${CTEST_BINARY_DIRECTORY}/AlbBuildSFad${SFAD_SIZE}"
