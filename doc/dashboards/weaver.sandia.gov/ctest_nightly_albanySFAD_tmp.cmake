...
if (BUILD_ALBANY_SFAD16)
  
  if (NOT EXISTS "${CTEST_BINARY_DIRECTORY}/AlbBuildSFad16")
    file (MAKE_DIRECTORY ${CTEST_BINARY_DIRECTORY}/AlbBuildSFad16)
  endif ()

  CTEST_CONFIGURE(
    BUILD "${CTEST_BINARY_DIRECTORY}/AlbBuildSFad16"
    SOURCE "/home/projects/albany/nightlyCDashWeaver/repos/Albany"
    OPTIONS "${CONFIGURE_OPTIONS}"
    RETURN_VALUE HAD_ERROR
    )
