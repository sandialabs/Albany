...
if (BUILD_TRILINOS) 
  ...
  #
  set_property (GLOBAL PROPERTY SubProject GaiaTrilinos)
...
if (BUILD_ALB_Aeras)
  ...
  set_property (GLOBAL PROPERTY SubProject GaiaAlbanyAeras)
  set_property (GLOBAL PROPERTY Label GaiaAlbanyAeras)
  ...
  #CTEST_TEST(
  #  BUILD "${CTEST_BINARY_DIRECTORY}/GaiaAlbanyAeras"
