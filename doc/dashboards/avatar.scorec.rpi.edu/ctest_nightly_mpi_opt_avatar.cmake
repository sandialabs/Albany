...
#    RESULT_VARIABLE HAD_ERROR)
  EXECUTE_PROCESS(COMMAND "${CTEST_GIT_COMMAND}" 
    clone -b new_stk ${SCOREC_REPOSITORY_LOCATION} ${CTEST_SOURCE_DIRECTORY}/publicTrilinos/SCOREC
    OUTPUT_VARIABLE _out
    ERROR_VARIABLE _err
    RESULT_VARIABLE HAD_ERROR)
...
if(NOT EXISTS "${CTEST_SOURCE_DIRECTORY}/Albany")
  EXECUTE_PROCESS(COMMAND "${CTEST_GIT_COMMAND}" 
    clone -b temporary_tpetra_newSTK ${Albany_REPOSITORY_LOCATION} ${CTEST_SOURCE_DIRECTORY}/Albany
    OUTPUT_VARIABLE _out
    ERROR_VARIABLE _err
    RESULT_VARIABLE HAD_ERROR)
...
#
  ...
  "-DCMAKE_CXX_FLAGS:STRING=-O3 -w -DADDC_"
  "-DCMAKE_C_FLAGS:STRING=-O3 -w -DADDC_"
  "-DCMAKE_Fortran_FLAGS:STRING=-Os -w -DADDC_"
  "-DTrilinos_EXTRA_REPOSITORIES:STRING=SCOREC"
  "-DTrilinos_ENABLE_SCOREC:BOOL=ON"
  "-DSCOREC_DISABLE_STRONG_WARNINGS:BOOL=ON"
