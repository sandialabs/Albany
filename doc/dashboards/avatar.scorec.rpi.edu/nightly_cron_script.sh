...
export PATH=/lore/ghansen/nightly/build/TrilinosInstallClang/bin:/lore/ghansen/nightly/build/TrilinosInstall/bin:/users/ghansen/bin:/usr/local/bin:/usr/bin:/bin:/usr/X11R6/bin

#export LD_LIBRARY_PATH=/users/ghansen/lib64:/users/ghansen/lib64:/usr/local/intel/11.1/069/mkl/lib/em64t
