...
#set (CTEST_BUILD_NAME "mockba-rhel7.9-gcc10.1.0-${CTEST_BUILD_CONFIGURATION}-Albany")
...
set (CTEST_BUILD_NAME "Albany-${osname}-${osrel}-${COMPILER}-${COMPILER_VERSION}-${CTEST_BUILD_CONFIGURATION}-Serial")
...
if (BUILD_ALBANY)
  ...
  SET (ALBANY_INSTALL_DIR ${CTEST_BINARY_DIRECTORY}/IKTAlbanyMockbaInstall) 
  SET (CISM_SOURCE_DIR ${CTEST_SOURCE_DIRECTORY}/cism-piscees)
  ...
  set(CTEST_CUSTOM_MAXIMUM_PASSED_TEST_OUTPUT_SIZE 5000000000)
  set(CTEST_CUSTOM_MAXIMUM_FAILED_TEST_OUTPUT_SIZE 5000000000)
