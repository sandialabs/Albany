...
set key font ",16"
plot "RubiksCube_Implicit_force_displacement.txt" using 1:2 with points pt 7 ps 4 lc 2 title "Implicit Integration of CP Model", \
     "RubiksCube_Explicit_force_displacement.txt" using 1:2 with points pt 7 ps 4 lc 3 title "Explicit Integration of CP Model"
