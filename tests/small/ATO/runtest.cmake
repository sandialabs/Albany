...
if ("@EXO_REF_FILE_NAME@" STREQUAL "")
  SET (EXO_REF_FILE_NAME ${TEST_NAME_BARE}.ref.exo)
else()
  SET (EXO_REF_FILE_NAME @EXO_REF_FILE_NAME@)
endif()

if(@ALBANY_MPI@ AND @MPIMNP@ GREATER 1)
  SET(EXODIFF_TEST @SEACAS_EXODIFF@ -i -m -f @DATA_DIR@/${TEST_NAME_BARE}.exodiff_commands @EXO_FILE_NAME@.exo @DATA_DIR@/${EXO_REF_FILE_NAME})
ELSE()
  SET(EXODIFF_TEST @SEACAS_EXODIFF@ -i -f @DATA_DIR@/${TEST_NAME_BARE}.exodiff_commands @EXO_FILE_NAME@.exo @DATA_DIR@/${EXO_REF_FILE_NAME})
ENDIF()
