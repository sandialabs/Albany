...
if(HAD_ERROR)
	message(FATAL_ERROR "AlbanyRBGen didn't run: test failed")
endif()
...
if(DEFINED MPIMNP AND ${MPIMNP} GREATER 1)
  SET(EXODIFF_TEST ${SEACAS_EXODIFF} -steps 1:19:1 -i -m -f ${DATA_DIR}/${TEST_NAME}.exodiff ${OUTPUT_FILENAME} ${DATA_DIR}/${REF_FILENAME})
ELSE()
  SET(EXODIFF_TEST ${SEACAS_EXODIFF} -steps 1:19:1 -i -f ${DATA_DIR}/${TEST_NAME}.exodiff ${OUTPUT_FILENAME} ${DATA_DIR}/${REF_FILENAME})
ENDIF()
